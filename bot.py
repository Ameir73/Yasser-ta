    ...
    try:
        ...
        for coin in coins:
            ...
            is_buy_indicator_1 = (
                ...
                (ema_20_2h > ema_50_2h > ema_100_2h > ema_200_2h) and 
                (ema_20_2h > bb_middle_2h) and 
                (ema_20_2h > kc_lower_2h) and 
                (ichimoku_conversion_2h > ichimoku_base_2h) and 
                (ema_20_2h > supertrend_2h) and 
                (ema_20_2h > parabolic_sar_2h) and 
    ...
    try:
        ...
        for coin in coins:
            ...
            is_buy_momentum_3 = (
                ...
                (rsi_4h >= 66 and macd_4h >= 0.000627 and macd_signal_4h >= 0.000263 and macd_hist_4h >= 0.000365 and obv_4h >= 607252739 and obv_slope_4h >= 307382490 and adx_4h >= 88 and stochastic_k_4h >= 63 and stochastic_d_4h >= 77 and williams_r_4h >= -48)
            )
