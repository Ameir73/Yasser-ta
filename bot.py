...
async def intelligence_scanner():
    ...
    try:
        ...
        for coin in coins:
            ...
            # إذا كان السعر معدوماً، تجاوزها فوراً
            if price == 0:
            ...
            # ==========================================
            support_5m = float(coin.get('support_5m') or 0)
            resistance_5m = float(coin.get('resistance_5m') or 0)
            support_15m = float(coin.get('support_15m') or 0)
            resistance_15m = float(coin.get('resistance_15m') or 0)
            support_1h = float(coin.get('support_1h') or 0)
            resistance_1h = float(coin.get('resistance_1h') or 0)
            support_2h = float(coin.get('support_2h') or 0)
            resistance_2h = float(coin.get('resistance_2h') or 0)
            support_4h = float(coin.get('support_4h') or 0)
            resistance_4h = float(coin.get('resistance_4h') or 0)
            support_1d = float(coin.get('support_1d') or 0)
            resistance_1d = float(coin.get('resistance_1d') or 0)
...
async def intelligence_scanner2():
    """
    الرادار v11.1 (عين الصقر + القلعة المحصنة + فلتر الماكد)
    يدمج الدعوم والمقاومات المتعددة الفريمات، يتجاهل العملات الميتة والمزعجة، 
    ويضرب بيد من حديد في مناطق انضغاط السيولة وإبادة البائعين بتأكيد فني صارم.
    ...
    try:
        ...
        for coin in coins:
            ...
            # --- is_buy_indicator_5 ---
            is_buy_indicator_5 = (
                (ichimoku_conversion_1h > ichimoku_cloud_top_1h > ichimoku_base_1h > ichimoku_cloud_bottom_1h > kc_upper_1h > bb_upper_1h > ema_20_1h > kc_middle_1h > bb_middle_1h > ema_50_1h > ema_100_1h > supertrend_1h > ema_200_1h > parabolic_sar_1h > kc_lower_1h > bb_lower_1h > bbw_1h > was_squeezed_1h) and 
                (ichimoku_conversion_2h > ichimoku_cloud_top_2h > kc_upper_2h > ichimoku_base_2h > ichimoku_cloud_bottom_2h > bb_upper_2h > ema_20_2h > kc_middle_2h > bb_middle_2h > ema_50_2h > parabolic_sar_2h > ema_100_2h > supertrend_2h > ema_200_2h > kc_lower_2h > bb_lower_2h > bbw_2h > was_squeezed_2h)
            )

            # --- is_buy_indicator_6 ---
            is_buy_indicator_6 = (
                (ichimoku_conversion_1h > ichimoku_cloud_top_1h > ichimoku_base_1h > ichimoku_cloud_bottom_1h > kc_upper_1h > bb_upper_1h > supertrend_1h > ema_20_1h > kc_middle_1h > bb_middle_1h > ema_50_1h > parabolic_sar_1h > ema_100_1h > ema_200_1h > bb_lower_1h > kc_lower_1h > bbw_1h > was_squeezed_1h) and 
                (ichimoku_conversion_2h > ichimoku_cloud_top_2h > ichimoku_base_2h > ichimoku_cloud_bottom_2h > kc_upper_2h > bb_upper_2h > supertrend_2h > ema_20_2h > kc_middle_2h > bb_middle_2h > parabolic_sar_2h > ema_50_2h > ema_100_2h > ema_200_2h > bb_lower_2h > kc_lower_2h > bbw_2h > was_squeezed_2h) and 
                (ichimoku_conversion_4h > ichimoku_cloud_top_4h > ichimoku_base_4h > kc_upper_4h > bb_upper_4h > ichimoku_cloud_bottom_4h > supertrend_4h > ema_20_4h > kc_middle_4h > bb_middle_4h > parabolic_sar_4h > ema_200_4h > ema_50_4h > ema_100_4h > kc_lower_4h > bb_lower_4h > bbw_4h > was_squeezed_4h)
            )

            # --- is_buy_indicator_7 ---
            is_buy_indicator_7 = (
                (bb_upper_1h > kc_upper_1h > ichimoku_conversion_1h > bb_middle_1h > ichimoku_cloud_top_1h > ema_20_1h > kc_middle_1h > parabolic_sar_1h > supertrend_1h > ichimoku_base_1h > bbw_1h > bb_lower_1h > ichimoku_cloud_bottom_1h > ema_50_1h > kc_lower_1h > ema_100_1h > ema_200_1h > was_squeezed_1h) and 
                (bbw_2h > bb_upper_2h > kc_upper_2h > ichimoku_conversion_2h > ichimoku_cloud_top_2h > parabolic_sar_2h > ema_20_2h > kc_middle_2h > ichimoku_base_2h > supertrend_2h > bb_middle_2h > ichimoku_cloud_bottom_2h > ema_50_2h > kc_lower_2h > ema_100_2h > ema_200_2h > bb_lower_2h > was_squeezed_2h) and 
                (bbw_4h > bb_upper_4h > kc_upper_4h > ichimoku_conversion_4h > ichimoku_cloud_top_4h > ichimoku_base_4h > ema_20_4h > kc_middle_4h > bb_middle_4h > supertrend_4h > parabolic_sar_4h > ema_50_4h > ichimoku_cloud_bottom_4h > kc_lower_4h > ema_100_4h > bb_lower_4h > ema_200_4h > was_squeezed_4h)
            )

            # --- is_buy_indicator_8 ---
            is_buy_indicator_8 = (
                (bbw_1h > ichimoku_conversion_1h > ichimoku_cloud_top_1h > ichimoku_base_1h > ichimoku_cloud_bottom_1h > bb_upper_1h > kc_upper_1h > supertrend_1h > ema_20_1h > kc_middle_1h > ema_200_1h > ema_50_1h > ema_100_1h > bb_middle_1h > parabolic_sar_1h > kc_lower_1h > bb_lower_1h > was_squeezed_1h) and 
                (bbw_2h > ichimoku_base_2h > ichimoku_cloud_bottom_2h > ichimoku_cloud_top_2h > ichimoku_conversion_2h > kc_upper_2h > bb_upper_2h > ema_200_2h > ema_100_2h > ema_20_2h > kc_middle_2h > bb_middle_2h > ema_50_2h > supertrend_2h > parabolic_sar_2h > kc_lower_2h > bb_lower_2h > was_squeezed_2h) and 
                (bbw_4h > ichimoku_base_4h > ichimoku_cloud_top_4h > ichimoku_conversion_4h > ichimoku_cloud_bottom_4h > kc_upper_4h > ema_200_4h > bb_upper_4h > ema_100_4h > ema_50_4h > ema_20_4h > kc_middle_4h > bb_middle_4h > supertrend_4h > parabolic_sar_4h > bb_lower_4h > kc_lower_4h > was_squeezed_4h)
            )

            # --- is_buy_indicator_9 ---
            is_buy_indicator_9 = (
                (bbw_1h > bb_upper_1h > kc_upper_1h > ichimoku_conversion_1h > parabolic_sar_1h > ichimoku_cloud_top_1h > ema_20_1h > kc_middle_1h > bb_middle_1h > ichimoku_base_1h > ichimoku_cloud_bottom_1h > ema_50_1h > kc_lower_1h > supertrend_1h > ema_100_1h > bb_lower_1h > ema_200_1h > was_squeezed_1h) and 
                (bbw_2h > kc_upper_2h > bb_upper_2h > ichimoku_conversion_2h > ichimoku_cloud_top_2h > ichimoku_base_2h > ema_20_2h > kc_middle_2h > bb_middle_2h > parabolic_sar_2h > ema_50_2h > ichimoku_cloud_bottom_2h > supertrend_2h > kc_lower_2h > bb_lower_2h > ema_100_2h > ema_200_2h > was_squeezed_2h) and 
                (bbw_4h > bb_upper_4h > kc_upper_4h > ichimoku_conversion_4h > ichimoku_cloud_top_4h > ema_20_4h > kc_middle_4h > bb_middle_4h > ichimoku_base_4h > parabolic_sar_4h > ichimoku_cloud_bottom_4h > ema_50_4h > supertrend_4h > ema_100_4h > kc_lower_4h > ema_200_4h > bb_lower_4h > was_squeezed_4h)
            )

            # --- is_buy_indicator_10 ---
            is_buy_indicator_10 = (
                (bbw_1h > kc_upper_1h > bb_upper_1h > ichimoku_conversion_1h > bb_middle_1h > ema_20_1h > kc_middle_1h > ichimoku_cloud_top_1h > parabolic_sar_1h > ichimoku_base_1h > bb_lower_1h > ichimoku_cloud_bottom_1h > ema_50_1h > kc_lower_1h > ema_100_1h > ema_200_1h > supertrend_1h > was_squeezed_1h) and 
                (bbw_2h > bb_upper_2h > kc_upper_2h > ichimoku_conversion_2h > ichimoku_cloud_top_2h > ichimoku_base_2h > parabolic_sar_2h > ema_20_2h > kc_middle_2h > ichimoku_cloud_bottom_2h > bb_middle_2h > ema_50_2h > ema_100_2h > ema_200_2h > kc_lower_2h > supertrend_2h > bb_lower_2h > was_squeezed_2h) and 
                (bbw_4h > supertrend_4h > parabolic_sar_4h > bb_upper_4h > kc_upper_4h > ichimoku_conversion_4h > ichimoku_cloud_top_4h > ichimoku_base_4h > ichimoku_cloud_bottom_4h > ema_20_4h > kc_middle_4h > ema_200_4h > bb_middle_4h > ema_50_4h > ema_100_4h > kc_lower_4h > bb_lower_4h > was_squeezed_4h)
            )

            # --- is_buy_indicator_11 ---
            is_buy_indicator_11 = (
                (bb_upper_1h > kc_upper_1h > ichimoku_conversion_1h > ichimoku_cloud_top_1h > ichimoku_base_1h > ichimoku_cloud_bottom_1h > parabolic_sar_1h > ema_20_1h > kc_middle_1h > bb_middle_1h > supertrend_1h > ema_50_1h > ema_100_1h > kc_lower_1h > ema_200_1h > bb_lower_1h > bbw_1h > was_squeezed_1h) and 
                (bb_upper_2h > kc_upper_2h > ichimoku_conversion_2h > ichimoku_cloud_top_2h > ichimoku_base_2h > ichimoku_cloud_bottom_2h > ema_20_2h > kc_middle_2h > supertrend_2h > bb_middle_2h > ema_50_2h > parabolic_sar_2h > ema_100_2h > kc_lower_2h > ema_200_2h > bb_lower_2h > bbw_2h > was_squeezed_2h) and 
                (bb_upper_4h > kc_upper_4h > ichimoku_conversion_4h > ichimoku_cloud_top_4h > ichimoku_base_4h > ichimoku_cloud_bottom_4h > ema_20_4h > kc_middle_4h > supertrend_4h > bb_middle_4h > ema_50_4h > parabolic_sar_4h > ema_100_4h > ema_200_4h > kc_lower_4h > bb_lower_4h > bbw_4h > was_squeezed_4h)
            )

            # --- is_buy_indicator_12 ---
            is_buy_indicator_12 = (
                (bbw_1h > supertrend_1h > parabolic_sar_1h > bb_upper_1h > ichimoku_conversion_1h > kc_upper_1h > ichimoku_cloud_top_1h > ichimoku_base_1h > ichimoku_cloud_bottom_1h > ema_20_1h > kc_middle_1h > bb_middle_1h > ema_50_1h > ema_100_1h > ema_200_1h > kc_lower_1h > bb_lower_1h > was_squeezed_1h) and 
                (bbw_2h > ichimoku_conversion_2h > ichimoku_cloud_top_2h > ichimoku_base_2h > bb_upper_2h > ichimoku_cloud_bottom_2h > kc_upper_2h > supertrend_2h > ema_20_2h > kc_middle_2h > bb_middle_2h > ema_200_2h > ema_50_2h > parabolic_sar_2h > ema_100_2h > kc_lower_2h > bb_lower_2h > was_squeezed_2h) and 
                (bbw_4h > ichimoku_conversion_4h > ichimoku_cloud_top_4h > ichimoku_base_4h > ichimoku_cloud_bottom_4h > bb_upper_4h > kc_upper_4h > supertrend_4h > ema_200_4h > ema_20_4h > kc_middle_4h > ema_100_4h > bb_middle_4h > ema_50_4h > parabolic_sar_4h > kc_lower_4h > bb_lower_4h > was_squeezed_4h)
            )

            # --- is_buy_indicator_13 ---
            is_buy_indicator_13 = (
                (bbw_1h > supertrend_1h > bb_upper_1h > parabolic_sar_1h > kc_upper_1h > ichimoku_conversion_1h > ichimoku_cloud_top_1h > ichimoku_base_1h > ichimoku_cloud_bottom_1h > ema_20_1h > kc_middle_1h > bb_middle_1h > ema_50_1h > ema_100_1h > ema_200_1h > kc_lower_1h > bb_lower_1h > was_squeezed_1h) and 
                (bbw_2h > supertrend_2h > parabolic_sar_2h > bb_upper_2h > kc_upper_2h > ichimoku_conversion_2h > ichimoku_cloud_top_2h > ichimoku_base_2h > ichimoku_cloud_bottom_2h > ema_20_2h > kc_middle_2h > bb_middle_2h > ema_50_2h > ema_100_2h > ema_200_2h > kc_lower_2h > bb_lower_2h > was_squeezed_2h) and 
                (bbw_4h > bb_upper_4h > kc_upper_4h > ichimoku_conversion_4h > ichimoku_cloud_top_4h > ichimoku_base_4h > ichimoku_cloud_bottom_4h > ema_200_4h > ema_20_4h > kc_middle_4h > bb_middle_4h > ema_100_4h > ema_50_4h > supertrend_4h > parabolic_sar_4h > kc_lower_4h > bb_lower_4h > was_squeezed_4h)
            )

            # --- is_buy_indicator_14 ---
            is_buy_indicator_14 = (
                (bbw_1h > bb_upper_1h > kc_upper_1h > ichimoku_conversion_1h > ichimoku_cloud_top_1h > bb_middle_1h > ichimoku_base_1h > ema_20_1h > kc_middle_1h > ichimoku_cloud_bottom_1h > parabolic_sar_1h > ema_50_1h > ema_100_1h > ema_200_1h > kc_lower_1h > bb_lower_1h > supertrend_1h > was_squeezed_1h) and 
                (bbw_2h > bb_upper_2h > kc_upper_2h > ichimoku_conversion_2h > ichimoku_cloud_top_2h > ichimoku_base_2h > parabolic_sar_2h > ichimoku_cloud_bottom_2h > ema_20_2h > kc_middle_2h > bb_middle_2h > ema_200_2h > ema_50_2h > ema_100_2h > supertrend_2h > kc_lower_2h > bb_lower_2h > was_squeezed_2h) and 
                (bbw_4h > kc_upper_4h > bb_upper_4h > ichimoku_conversion_4h > ichimoku_cloud_top_4h > ichimoku_base_4h > ichimoku_cloud_bottom_4h > ema_200_4h > ema_20_4h > kc_middle_4h > ema_100_4h > ema_50_4h > bb_middle_4h > supertrend_4h > parabolic_sar_4h > kc_lower_4h > bb_lower_4h > was_squeezed_4h)
            )

            # --- is_buy_indicator_15 ---
            is_buy_indicator_15 = (
                (bbw_1h > parabolic_sar_1h > supertrend_1h > bb_upper_1h > kc_upper_1h > ichimoku_conversion_1h > ichimoku_cloud_top_1h > ichimoku_base_1h > ichimoku_cloud_bottom_1h > ema_20_1h > kc_middle_1h > ema_200_1h > bb_middle_1h > ema_50_1h > ema_100_1h > kc_lower_1h > bb_lower_1h > was_squeezed_1h) and 
                (bbw_2h > parabolic_sar_2h > supertrend_2h > ichimoku_conversion_2h > kc_upper_2h > ichimoku_cloud_top_2h > ichimoku_base_2h > ichimoku_cloud_bottom_2h > bb_upper_2h > ema_200_2h > ema_100_2h > ema_20_2h > kc_middle_2h > ema_50_2h > bb_middle_2h > bb_lower_2h > kc_lower_2h > was_squeezed_2h) and 
                (bbw_4h > kc_upper_4h > ema_200_4h > ichimoku_base_4h > ichimoku_cloud_bottom_4h > ichimoku_cloud_top_4h > ichimoku_conversion_4h > bb_upper_4h > ema_100_4h > ema_50_4h > ema_20_4h > kc_middle_4h > bb_middle_4h > parabolic_sar_4h > supertrend_4h > bb_lower_4h > kc_lower_4h > was_squeezed_4h)
            )

            # --- is_buy_indicator_16 ---
            is_buy_indicator_16 = (
                (bbw_1h > bb_upper_1h > kc_upper_1h > ichimoku_conversion_1h > parabolic_sar_1h > ichimoku_cloud_top_1h > ema_20_1h > kc_middle_1h > ema_200_1h > bb_middle_1h > ichimoku_base_1h > ichimoku_cloud_bottom_1h > ema_50_1h > ema_100_1h > supertrend_1h > kc_lower_1h > bb_lower_1h > was_squeezed_1h) and 
                (bbw_2h > bb_upper_2h > kc_upper_2h > ema_200_2h > ichimoku_conversion_2h > ema_100_2h > ichimoku_cloud_top_2h > parabolic_sar_2h > ema_20_2h > kc_middle_2h > ichimoku_base_2h > ichimoku_cloud_bottom_2h > ema_50_2h > bb_middle_2h > supertrend_2h > kc_lower_2h > bb_lower_2h > was_squeezed_2h) and 
                (bbw_4h > supertrend_4h > parabolic_sar_4h > bb_upper_4h > kc_upper_4h > ema_100_4h > ichimoku_cloud_bottom_4h > ema_50_4h > ichimoku_base_4h > ichimoku_cloud_top_4h > ichimoku_conversion_4h > ema_200_4h > ema_20_4h > kc_middle_4h > bb_middle_4h > kc_lower_4h > bb_lower_4h > was_squeezed_4h)
            )

            # --- is_buy_indicator_17 ---
            is_buy_indicator_17 = (
                (bbw_1h > supertrend_1h > parabolic_sar_1h > bb_upper_1h > kc_upper_1h > ichimoku_conversion_1h > ichimoku_cloud_top_1h > ichimoku_base_1h > ichimoku_cloud_bottom_1h > ema_20_1h > kc_middle_1h > bb_middle_1h > ema_50_1h > ema_200_1h > ema_100_1h > kc_lower_1h > bb_lower_1h > was_squeezed_1h) and 
                (bbw_2h > supertrend_2h > parabolic_sar_2h > kc_upper_2h > ichimoku_conversion_2h > ichimoku_cloud_top_2h > bb_upper_2h > ichimoku_base_2h > ichimoku_cloud_bottom_2h > ema_20_2h > kc_middle_2h > ema_200_2h > ema_50_2h > ema_100_2h > bb_middle_2h > kc_lower_2h > bb_lower_2h > was_squeezed_2h) and 
                (bbw_4h > supertrend_4h > parabolic_sar_4h > ichimoku_base_4h > ichimoku_cloud_bottom_4h > ichimoku_cloud_top_4h > ichimoku_conversion_4h > kc_upper_4h > bb_upper_4h > ema_200_4h > ema_100_4h > ema_20_4h > kc_middle_4h > ema_50_4h > bb_middle_4h > kc_lower_4h > bb_lower_4h > was_squeezed_4h)
            )

            # --- is_buy_indicator_18 ---
            is_buy_indicator_18 = (
                (bbw_1h > parabolic_sar_1h > supertrend_1h > kc_upper_1h > bb_upper_1h > ichimoku_conversion_1h > ichimoku_cloud_top_1h > ichimoku_base_1h > ichimoku_cloud_bottom_1h > ema_20_1h > kc_middle_1h > bb_middle_1h > ema_200_1h > ema_50_1h > ema_100_1h > kc_lower_1h > bb_lower_1h > was_squeezed_1h) and 
                (bbw_2h > parabolic_sar_2h > supertrend_2h > ichimoku_conversion_2h > kc_upper_2h > ichimoku_cloud_top_2h > ichimoku_base_2h > ichimoku_cloud_bottom_2h > bb_upper_2h > ema_200_2h > ema_20_2h > kc_middle_2h > ema_100_2h > ema_50_2h > bb_middle_2h > kc_lower_2h > bb_lower_2h > was_squeezed_2h) and 
                (bbw_4h > parabolic_sar_4h > supertrend_4h > ichimoku_base_4h > ichimoku_cloud_bottom_4h > ichimoku_cloud_top_4h > ichimoku_conversion_4h > kc_upper_4h > bb_upper_4h > ema_200_4h > ema_100_4h > ema_50_4h > ema_20_4h > kc_middle_4h > bb_middle_4h > bb_lower_4h > kc_lower_4h > was_squeezed_4h)
            )

            # --- is_buy_indicator_19 ---
            is_buy_indicator_19 = (
                (bbw_1h > kc_upper_1h > bb_upper_1h > ichimoku_conversion_1h > ichimoku_cloud_top_1h > parabolic_sar_1h > bb_middle_1h > ema_20_1h > kc_middle_1h > ichimoku_base_1h > ichimoku_cloud_bottom_1h > supertrend_1h > ema_50_1h > bb_lower_1h > kc_lower_1h > ema_100_1h > ema_200_1h > was_squeezed_1h) and 
                (bbw_2h > bb_upper_2h > kc_upper_2h > ichimoku_conversion_2h > ichimoku_cloud_top_2h > ichimoku_base_2h > ichimoku_cloud_bottom_2h > ema_20_2h > kc_middle_2h > parabolic_sar_2h > supertrend_2h > bb_middle_2h > ema_200_2h > ema_50_2h > ema_100_2h > kc_lower_2h > bb_lower_2h > was_squeezed_2h) and 
                (bbw_4h > bb_upper_4h > kc_upper_4h > ema_200_4h > ichimoku_base_4h > ichimoku_cloud_bottom_4h > ichimoku_cloud_top_4h > ichimoku_conversion_4h > ema_20_4h > kc_middle_4h > ema_100_4h > supertrend_4h > ema_50_4h > bb_middle_4h > kc_lower_4h > parabolic_sar_4h > bb_lower_4h > was_squeezed_4h)
            )

            # --- is_buy_indicator_20 ---
            is_buy_indicator_20 = (
                (bb_upper_1h > kc_upper_1h > ichimoku_conversion_1h > ichimoku_cloud_top_1h > ichimoku_base_1h > ema_20_1h > kc_middle_1h > bb_middle_1h > supertrend_1h > ichimoku_cloud_bottom_1h > parabolic_sar_1h > ema_50_1h > kc_lower_1h > bb_lower_1h > ema_100_1h > bbw_1h > ema_200_1h > was_squeezed_1h) and 
                (bbw_2h > bb_upper_2h > kc_upper_2h > ichimoku_conversion_2h > ichimoku_cloud_top_2h > ichimoku_base_2h > ema_20_2h > kc_middle_2h > parabolic_sar_2h > bb_middle_2h > ichimoku_cloud_bottom_2h > supertrend_2h > ema_50_2h > kc_lower_2h > ema_100_2h > bb_lower_2h > ema_200_2h > was_squeezed_2h) and 
                (bbw_4h > bb_upper_4h > kc_upper_4h > ichimoku_conversion_4h > ichimoku_cloud_top_4h > ichimoku_base_4h > ema_20_4h > kc_middle_4h > ichimoku_cloud_bottom_4h > bb_middle_4h > parabolic_sar_4h > supertrend_4h > ema_50_4h > kc_lower_4h > ema_100_4h > bb_lower_4h > ema_200_4h > was_squeezed_4h)
            )

            # --- is_buy_indicator_21 ---
            is_buy_indicator_21 = (
                (bbw_1h > bb_upper_1h > kc_upper_1h > ichimoku_conversion_1h > ichimoku_cloud_top_1h > ichimoku_base_1h > ema_20_1h > kc_middle_1h > ichimoku_cloud_bottom_1h > parabolic_sar_1h > bb_middle_1h > ema_50_1h > ema_100_1h > kc_lower_1h > ema_200_1h > supertrend_1h > bb_lower_1h > was_squeezed_1h) and 
                (bbw_2h > bb_upper_2h > kc_upper_2h > ichimoku_conversion_2h > ichimoku_cloud_top_2h > ichimoku_base_2h > ichimoku_cloud_bottom_2h > ema_20_2h > kc_middle_2h > bb_middle_2h > parabolic_sar_2h > ema_50_2h > ema_100_2h > ema_200_2h > supertrend_2h > kc_lower_2h > bb_lower_2h > was_squeezed_2h) and 
                (bbw_4h > bb_upper_4h > kc_upper_4h > ichimoku_conversion_4h > ichimoku_cloud_top_4h > ichimoku_base_4h > ichimoku_cloud_bottom_4h > ema_20_4h > kc_middle_4h > ema_200_4h > ema_100_4h > bb_middle_4h > ema_50_4h > supertrend_4h > parabolic_sar_4h > kc_lower_4h > bb_lower_4h > was_squeezed_4h)
            )

            # --- is_buy_indicator_22 ---
            is_buy_indicator_22 = (
                (bbw_1h > bb_upper_1h > supertrend_1h > kc_upper_1h > parabolic_sar_1h > ichimoku_base_1h > ichimoku_cloud_bottom_1h > ichimoku_cloud_top_1h > ichimoku_conversion_1h > bb_middle_1h > ema_20_1h > kc_middle_1h > ema_50_1h > ema_100_1h > ema_200_1h > kc_lower_1h > bb_lower_1h > was_squeezed_1h) and 
                (bbw_2h > supertrend_2h > bb_upper_2h > parabolic_sar_2h > kc_upper_2h > ichimoku_conversion_2h > ichimoku_cloud_top_2h > ichimoku_base_2h > ichimoku_cloud_bottom_2h > ema_20_2h > kc_middle_2h > bb_middle_2h > ema_50_2h > ema_200_2h > ema_100_2h > kc_lower_2h > bb_lower_2h > was_squeezed_2h) and 
                (bbw_4h > bb_upper_4h > kc_upper_4h > ichimoku_conversion_4h > ichimoku_cloud_top_4h > ichimoku_base_4h > ichimoku_cloud_bottom_4h > ema_200_4h > ema_20_4h > kc_middle_4h > ema_100_4h > ema_50_4h > bb_middle_4h > parabolic_sar_4h > supertrend_4h > kc_lower_4h > bb_lower_4h > was_squeezed_4h)
            )

            # --- is_buy_indicator_23 ---
            is_buy_indicator_23 = (
                (bbw_1h > supertrend_1h > bb_upper_1h > kc_upper_1h > parabolic_sar_1h > ichimoku_conversion_1h > ichimoku_cloud_top_1h > ichimoku_base_1h > bb_middle_1h > ichimoku_cloud_bottom_1h > ema_20_1h > kc_middle_1h > ema_50_1h > ema_200_1h > ema_100_1h > bb_lower_1h > kc_lower_1h > was_squeezed_1h) and 
                (bbw_2h > supertrend_2h > bb_upper_2h > parabolic_sar_2h > kc_upper_2h > ichimoku_conversion_2h > ichimoku_cloud_top_2h > ichimoku_base_2h > ichimoku_cloud_bottom_2h > ema_20_2h > kc_middle_2h > bb_middle_2h > ema_200_2h > ema_50_2h > ema_100_2h > kc_lower_2h > bb_lower_2h > was_squeezed_2h) and 
                (bbw_4h > supertrend_4h > parabolic_sar_4h > bb_upper_4h > kc_upper_4h > ichimoku_conversion_4h > ichimoku_cloud_top_4h > ichimoku_base_4h > ichimoku_cloud_bottom_4h > ema_200_4h > ema_100_4h > ema_20_4h > kc_middle_4h > ema_50_4h > bb_middle_4h > kc_lower_4h > bb_lower_4h > was_squeezed_4h)
            )

            # --- is_buy_indicator_24 ---
            is_buy_indicator_24 = (
                (was_squeezed_1h > ema_200_1h > ema_100_1h > kc_upper_1h > bb_upper_1h > ema_50_1h > ema_20_1h > kc_middle_1h > ichimoku_conversion_1h > parabolic_sar_1h > bb_middle_1h > ichimoku_cloud_top_1h > ichimoku_cloud_bottom_1h > ichimoku_base_1h > kc_lower_1h > supertrend_1h > bb_lower_1h > bbw_1h) and 
                (bbw_2h > ema_200_2h > bb_upper_2h > kc_upper_2h > ema_100_2h > supertrend_2h > ema_50_2h > parabolic_sar_2h > bb_middle_2h > ema_20_2h > kc_middle_2h > ichimoku_cloud_bottom_2h > bb_lower_2h > kc_lower_2h > ichimoku_base_2h > ichimoku_cloud_top_2h > ichimoku_conversion_2h > was_squeezed_2h) and 
                (ema_200_4h > bbw_4h > ema_100_4h > kc_upper_4h > bb_upper_4h > ema_50_4h > supertrend_4h > parabolic_sar_4h > bb_middle_4h > ema_20_4h > kc_middle_4h > ichimoku_cloud_bottom_4h > bb_lower_4h > ichimoku_base_4h > ichimoku_cloud_top_4h > kc_lower_4h > ichimoku_conversion_4h > was_squeezed_4h)
            )

            # --- is_buy_indicator_25 ---
            is_buy_indicator_25 = (
                (ema_200_1h > supertrend_1h > parabolic_sar_1h > ema_100_1h > kc_upper_1h > bb_upper_1h > ema_50_1h > ichimoku_conversion_1h > ichimoku_cloud_bottom_1h > ichimoku_cloud_top_1h > ema_20_1h > kc_middle_1h > ichimoku_base_1h > bb_middle_1h > kc_lower_1h > bb_lower_1h > bbw_1h > was_squeezed_1h) and 
                (bb_upper_2h > supertrend_2h > kc_upper_2h > bbw_2h > ema_200_2h > ema_100_2h > parabolic_sar_2h > ema_50_2h > ichimoku_cloud_bottom_2h > ema_20_2h > kc_middle_2h > bb_middle_2h > ichimoku_base_2h > ichimoku_cloud_top_2h > ichimoku_conversion_2h > kc_lower_2h > bb_lower_2h > was_squeezed_2h) and 
                (bbw_4h > ema_200_4h > bb_upper_4h > kc_upper_4h > supertrend_4h > ema_100_4h > ema_50_4h > ichimoku_cloud_bottom_4h > parabolic_sar_4h > bb_middle_4h > ichimoku_base_4h > ema_20_4h > kc_middle_4h > ichimoku_cloud_top_4h > ichimoku_conversion_4h > kc_lower_4h > bb_lower_4h > was_squeezed_4h)
            )

            # --- is_buy_indicator_26 ---
            is_buy_indicator_26 = (
                (bb_upper_1h > kc_upper_1h > ichimoku_conversion_1h > ichimoku_cloud_top_1h > ema_20_1h > kc_middle_1h > bb_middle_1h > ichimoku_base_1h > supertrend_1h > parabolic_sar_1h > ichimoku_cloud_bottom_1h > ema_50_1h > kc_lower_1h > ema_100_1h > ema_200_1h > bb_lower_1h > bbw_1h > was_squeezed_1h) and 
                (bb_upper_2h > kc_upper_2h > ichimoku_conversion_2h > ichimoku_cloud_top_2h > ichimoku_base_2h > parabolic_sar_2h > ema_20_2h > kc_middle_2h > ichimoku_cloud_bottom_2h > supertrend_2h > bb_middle_2h > ema_50_2h > ema_100_2h > kc_lower_2h > ema_200_2h > bb_lower_2h > bbw_2h > was_squeezed_2h) and 
                (bb_upper_4h > kc_upper_4h > ichimoku_conversion_4h > ichimoku_cloud_top_4h > ichimoku_base_4h > ichimoku_cloud_bottom_4h > ema_20_4h > kc_middle_4h > bb_middle_4h > supertrend_4h > ema_50_4h > ema_100_4h > parabolic_sar_4h > kc_lower_4h > ema_200_4h > bb_lower_4h > bbw_4h > was_squeezed_4h)
            )

            # --- is_buy_indicator_27 ---
            is_buy_indicator_27 = (
                (bbw_1h > bb_upper_1h > kc_upper_1h > ichimoku_conversion_1h > parabolic_sar_1h > ichimoku_cloud_top_1h > ichimoku_base_1h > ichimoku_cloud_bottom_1h > ema_20_1h > kc_middle_1h > bb_middle_1h > ema_50_1h > supertrend_1h > ema_100_1h > kc_lower_1h > ema_200_1h > bb_lower_1h > was_squeezed_1h) and 
                (bbw_2h > supertrend_2h > parabolic_sar_2h > bb_upper_2h > kc_upper_2h > ichimoku_conversion_2h > ichimoku_cloud_top_2h > ichimoku_base_2h > ichimoku_cloud_bottom_2h > ema_20_2h > kc_middle_2h > bb_middle_2h > ema_50_2h > ema_100_2h > ema_200_2h > kc_lower_2h > bb_lower_2h > was_squeezed_2h) and 
                (bbw_4h > bb_upper_4h > kc_upper_4h > ichimoku_conversion_4h > ichimoku_cloud_top_4h > ichimoku_base_4h > ichimoku_cloud_bottom_4h > ema_20_4h > kc_middle_4h > bb_middle_4h > supertrend_4h > ema_200_4h > ema_50_4h > parabolic_sar_4h > ema_100_4h > kc_lower_4h > bb_lower_4h > was_squeezed_4h)
            )

            # --- is_buy_indicator_28 ---
            is_buy_indicator_28 = (
                (bbw_1h > supertrend_1h > bb_upper_1h > parabolic_sar_1h > kc_upper_1h > ichimoku_conversion_1h > ichimoku_cloud_top_1h > ema_20_1h > kc_middle_1h > bb_middle_1h > ichimoku_base_1h > ichimoku_cloud_bottom_1h > ema_50_1h > kc_lower_1h > ema_100_1h > bb_lower_1h > ema_200_1h > was_squeezed_1h) and 
                (bbw_2h > supertrend_2h > bb_upper_2h > parabolic_sar_2h > kc_upper_2h > ichimoku_conversion_2h > ichimoku_cloud_top_2h > ichimoku_base_2h > ema_20_2h > kc_middle_2h > bb_middle_2h > ichimoku_cloud_bottom_2h > ema_50_2h > ema_100_2h > kc_lower_2h > ema_200_2h > bb_lower_2h > was_squeezed_2h) and 
                (bbw_4h > supertrend_4h > parabolic_sar_4h > bb_upper_4h > kc_upper_4h > ichimoku_conversion_4h > ichimoku_cloud_top_4h > ichimoku_base_4h > ema_20_4h > kc_middle_4h > ichimoku_cloud_bottom_4h > bb_middle_4h > ema_50_4h > ema_100_4h > ema_200_4h > kc_lower_4h > bb_lower_4h > was_squeezed_4h)
            )

            # --- is_buy_indicator_29 ---
            is_buy_indicator_29 = (
                (bbw_1h > ichimoku_conversion_1h > ichimoku_cloud_top_1h > ichimoku_base_1h > ichimoku_cloud_bottom_1h > bb_upper_1h > kc_upper_1h > supertrend_1h > ema_20_1h > kc_middle_1h > bb_middle_1h > ema_50_1h > ema_100_1h > ema_200_1h > parabolic_sar_1h > kc_lower_1h > bb_lower_1h > was_squeezed_1h) and 
                (bbw_2h > ichimoku_base_2h > ichimoku_cloud_top_2h > ichimoku_conversion_2h > ichimoku_cloud_bottom_2h > bb_upper_2h > kc_upper_2h > supertrend_2h > ema_200_2h > ema_20_2h > kc_middle_2h > bb_middle_2h > ema_100_2h > ema_50_2h > parabolic_sar_2h > kc_lower_2h > bb_lower_2h > was_squeezed_2h) and 
                (bbw_4h > ichimoku_conversion_4h > ichimoku_cloud_top_4h > ichimoku_base_4h > ichimoku_cloud_bottom_4h > bb_upper_4h > kc_upper_4h > ema_200_4h > ema_100_4h > ema_20_4h > kc_middle_4h > supertrend_4h > ema_50_4h > bb_middle_4h > parabolic_sar_4h > kc_lower_4h > bb_lower_4h > was_squeezed_4h)
            )

            # --- is_buy_indicator_30 ---
            is_buy_indicator_30 = (
                (bbw_1h > kc_upper_1h > bb_upper_1h > bb_middle_1h > ichimoku_conversion_1h > ichimoku_cloud_top_1h > ema_20_1h > kc_middle_1h > parabolic_sar_1h > ichimoku_base_1h > ichimoku_cloud_bottom_1h > bb_lower_1h > ema_50_1h > ema_100_1h > kc_lower_1h > ema_200_1h > supertrend_1h > was_squeezed_1h) and 
                (bbw_2h > bb_upper_2h > kc_upper_2h > ichimoku_conversion_2h > ichimoku_cloud_top_2h > ichimoku_base_2h > ichimoku_cloud_bottom_2h > ema_20_2h > kc_middle_2h > parabolic_sar_2h > bb_middle_2h > ema_50_2h > ema_100_2h > ema_200_2h > kc_lower_2h > supertrend_2h > bb_lower_2h > was_squeezed_2h) and 
                (bbw_4h > bb_upper_4h > kc_upper_4h > ichimoku_conversion_4h > ichimoku_cloud_top_4h > ichimoku_base_4h > ichimoku_cloud_bottom_4h > ema_20_4h > kc_middle_4h > bb_middle_4h > ema_200_4h > ema_50_4h > ema_100_4h > parabolic_sar_4h > supertrend_4h > kc_lower_4h > bb_lower_4h > was_squeezed_4h)
            )

            # --- is_buy_indicator_31 ---
            is_buy_indicator_31 = (
                (bbw_1h > bb_upper_1h > kc_upper_1h > ichimoku_conversion_1h > ichimoku_cloud_top_1h > ema_20_1h > kc_middle_1h > ichimoku_base_1h > bb_middle_1h > ichimoku_cloud_bottom_1h > parabolic_sar_1h > ema_50_1h > ema_100_1h > supertrend_1h > ema_200_1h > kc_lower_1h > bb_lower_1h > was_squeezed_1h) and 
                (bbw_2h > kc_upper_2h > bb_upper_2h > ichimoku_conversion_2h > ichimoku_cloud_top_2h > ichimoku_base_2h > ichimoku_cloud_bottom_2h > ema_20_2h > kc_middle_2h > parabolic_sar_2h > ema_200_2h > ema_50_2h > ema_100_2h > bb_middle_2h > supertrend_2h > kc_lower_2h > bb_lower_2h > was_squeezed_2h) and 
                (bbw_4h > kc_upper_4h > bb_upper_4h > ichimoku_cloud_bottom_4h > ichimoku_base_4h > ichimoku_cloud_top_4h > ichimoku_conversion_4h > ema_200_4h > ema_20_4h > kc_middle_4h > ema_100_4h > ema_50_4h > bb_middle_4h > parabolic_sar_4h > supertrend_4h > bb_lower_4h > kc_lower_4h > was_squeezed_4h)
            )

            # --- is_buy_indicator_32 ---
            is_buy_indicator_32 = (
                (bbw_1h > bb_upper_1h > kc_upper_1h > bb_middle_1h > ichimoku_conversion_1h > ichimoku_cloud_top_1h > ichimoku_base_1h > ema_20_1h > kc_middle_1h > ema_50_1h > parabolic_sar_1h > ichimoku_cloud_bottom_1h > bb_lower_1h > kc_lower_1h > supertrend_1h > ema_100_1h > ema_200_1h > was_squeezed_1h) and 
                (bbw_2h > bb_upper_2h > kc_upper_2h > ichimoku_conversion_2h > ichimoku_cloud_top_2h > bb_middle_2h > ema_20_2h > kc_middle_2h > parabolic_sar_2h > ichimoku_base_2h > ichimoku_cloud_bottom_2h > ema_50_2h > kc_lower_2h > supertrend_2h > ema_100_2h > bb_lower_2h > ema_200_2h > was_squeezed_2h) and 
                (bbw_4h > bb_upper_4h > kc_upper_4h > ichimoku_conversion_4h > ichimoku_cloud_top_4h > ichimoku_base_4h > ichimoku_cloud_bottom_4h > parabolic_sar_4h > ema_20_4h > kc_middle_4h > bb_middle_4h > ema_50_4h > supertrend_4h > ema_100_4h > kc_lower_4h > ema_200_4h > bb_lower_4h > was_squeezed_4h)
            )

            # --- is_buy_indicator_33 ---
            is_buy_indicator_33 = (
                (bbw_1h > bb_upper_1h > ichimoku_conversion_1h > ichimoku_cloud_top_1h > ichimoku_base_1h > ichimoku_cloud_bottom_1h > kc_upper_1h > supertrend_1h > ema_20_1h > kc_middle_1h > ema_200_1h > ema_100_1h > ema_50_1h > bb_middle_1h > parabolic_sar_1h > kc_lower_1h > bb_lower_1h > was_squeezed_1h) and 
                (bbw_2h > ichimoku_conversion_2h > ichimoku_cloud_top_2h > ichimoku_base_2h > ichimoku_cloud_bottom_2h > bb_upper_2h > kc_upper_2h > ema_200_2h > supertrend_2h > ema_20_2h > kc_middle_2h > ema_100_2h > ema_50_2h > bb_middle_2h > parabolic_sar_2h > kc_lower_2h > bb_lower_2h > was_squeezed_2h) and 
                (bbw_4h > bb_upper_4h > ichimoku_base_4h > ichimoku_cloud_bottom_4h > ichimoku_cloud_top_4h > ichimoku_conversion_4h > kc_upper_4h > ema_200_4h > ema_100_4h > supertrend_4h > ema_20_4h > kc_middle_4h > ema_50_4h > bb_middle_4h > parabolic_sar_4h > kc_lower_4h > bb_lower_4h > was_squeezed_4h)
            )

            # --- is_buy_indicator_34 ---
            is_buy_indicator_34 = (
                (bbw_1h > supertrend_1h > parabolic_sar_1h > bb_upper_1h > kc_upper_1h > ichimoku_conversion_1h > ichimoku_cloud_top_1h > ichimoku_base_1h > ichimoku_cloud_bottom_1h > ema_20_1h > kc_middle_1h > bb_middle_1h > ema_50_1h > ema_100_1h > kc_lower_1h > ema_200_1h > bb_lower_1h > was_squeezed_1h) and 
                (bbw_2h > bb_upper_2h > kc_upper_2h > ichimoku_conversion_2h > ichimoku_cloud_top_2h > ichimoku_base_2h > ichimoku_cloud_bottom_2h > ema_20_2h > kc_middle_2h > parabolic_sar_2h > bb_middle_2h > ema_50_2h > ema_200_2h > ema_100_2h > supertrend_2h > kc_lower_2h > bb_lower_2h > was_squeezed_2h) and 
                (bbw_4h > kc_upper_4h > bb_upper_4h > ichimoku_base_4h > ichimoku_cloud_top_4h > ichimoku_conversion_4h > ema_200_4h > ichimoku_cloud_bottom_4h > ema_20_4h > kc_middle_4h > bb_middle_4h > ema_100_4h > ema_50_4h > supertrend_4h > parabolic_sar_4h > kc_lower_4h > bb_lower_4h > was_squeezed_4h)
            )

            # --- is_buy_indicator_35 ---
            is_buy_indicator_35 = (
                (supertrend_1h > kc_upper_1h > parabolic_sar_1h > bb_upper_1h > ichimoku_conversion_1h > ichimoku_cloud_top_1h > ema_20_1h > kc_middle_1h > bb_middle_1h > ichimoku_base_1h > ichimoku_cloud_bottom_1h > ema_50_1h > kc_lower_1h > ema_100_1h > bb_lower_1h > ema_200_1h > bbw_1h > was_squeezed_1h) and 
                (supertrend_2h > parabolic_sar_2h > kc_upper_2h > bb_upper_2h > ichimoku_conversion_2h > ichimoku_cloud_top_2h > ichimoku_base_2h > ema_20_2h > kc_middle_2h > bb_middle_2h > ichimoku_cloud_bottom_2h > ema_50_2h > ema_100_2h > kc_lower_2h > bb_lower_2h > ema_200_2h > bbw_2h > was_squeezed_2h) and 
                (bb_upper_4h > kc_upper_4h > ichimoku_conversion_4h > ichimoku_cloud_top_4h > ichimoku_base_4h > ema_20_4h > kc_middle_4h > bb_middle_4h > ichimoku_cloud_bottom_4h > parabolic_sar_4h > supertrend_4h > ema_50_4h > ema_100_4h > kc_lower_4h > ema_200_4h > bb_lower_4h > bbw_4h > was_squeezed_4h)
            )

            # --- is_buy_indicator_36 ---
            is_buy_indicator_36 = (
                (bbw_1h > ema_200_1h > bb_upper_1h > ema_100_1h > ichimoku_cloud_bottom_1h > kc_upper_1h > ema_50_1h > parabolic_sar_1h > supertrend_1h > bb_middle_1h > ichimoku_base_1h > ema_20_1h > kc_middle_1h > ichimoku_cloud_top_1h > ichimoku_conversion_1h > kc_lower_1h > bb_lower_1h > was_squeezed_1h) and 
                (bbw_2h > ema_200_2h > ichimoku_cloud_bottom_2h > bb_upper_2h > ema_100_2h > kc_upper_2h > ema_50_2h > supertrend_2h > ichimoku_base_2h > parabolic_sar_2h > bb_middle_2h > ema_20_2h > kc_middle_2h > ichimoku_cloud_top_2h > ichimoku_conversion_2h > kc_lower_2h > bb_lower_2h > was_squeezed_2h) and 
                (bbw_4h > ema_200_4h > ema_100_4h > kc_upper_4h > ichimoku_base_4h > ichimoku_cloud_bottom_4h > bb_upper_4h > ema_50_4h > ichimoku_cloud_top_4h > bb_middle_4h > ema_20_4h > kc_middle_4h > ichimoku_conversion_4h > bb_lower_4h > parabolic_sar_4h > kc_lower_4h > supertrend_4h > was_squeezed_4h)
            )

            # --- is_buy_indicator_37 ---
            is_buy_indicator_37 = (
                (ema_200_1h > kc_upper_1h > ichimoku_conversion_1h > ichimoku_base_1h > ichimoku_cloud_top_1h > ichimoku_cloud_bottom_1h > ema_100_1h > bb_upper_1h > ema_50_1h > ema_20_1h > kc_middle_1h > bb_middle_1h > bb_lower_1h > parabolic_sar_1h > kc_lower_1h > supertrend_1h > bbw_1h > was_squeezed_1h) and 
                (ema_200_2h > ema_100_2h > kc_upper_2h > ichimoku_cloud_bottom_2h > ichimoku_base_2h > ichimoku_cloud_top_2h > ichimoku_conversion_2h > ema_50_2h > bb_upper_2h > ema_20_2h > kc_middle_2h > bb_middle_2h > bb_lower_2h > parabolic_sar_2h > kc_lower_2h > supertrend_2h > bbw_2h > was_squeezed_2h) and 
                (ema_200_4h > ema_100_4h > ichimoku_cloud_bottom_4h > kc_upper_4h > ema_50_4h > bb_upper_4h > ichimoku_conversion_4h > ichimoku_cloud_top_4h > ichimoku_base_4h > ema_20_4h > kc_middle_4h > bb_middle_4h > parabolic_sar_4h > bb_lower_4h > bbw_4h > kc_lower_4h > supertrend_4h > was_squeezed_4h)
            )

            # --- is_buy_indicator_38 ---
            is_buy_indicator_38 = (
                (bbw_1h > ema_200_1h > kc_upper_1h > bb_upper_1h > ema_100_1h > ichimoku_conversion_1h > ichimoku_cloud_top_1h > ichimoku_cloud_bottom_1h > ichimoku_base_1h > ema_50_1h > ema_20_1h > kc_middle_1h > parabolic_sar_1h > bb_middle_1h > supertrend_1h > kc_lower_1h > bb_lower_1h > was_squeezed_1h) and 
                (bbw_2h > ema_200_2h > ema_100_2h > kc_upper_2h > bb_upper_2h > ichimoku_conversion_2h > ichimoku_cloud_top_2h > ichimoku_base_2h > ichimoku_cloud_bottom_2h > ema_50_2h > ema_20_2h > kc_middle_2h > bb_middle_2h > supertrend_2h > parabolic_sar_2h > kc_lower_2h > bb_lower_2h > was_squeezed_2h) and 
                (bbw_4h > ema_200_4h > ema_100_4h > kc_upper_4h > bb_upper_4h > ichimoku_base_4h > ichimoku_cloud_bottom_4h > ichimoku_cloud_top_4h > ichimoku_conversion_4h > ema_50_4h > ema_20_4h > kc_middle_4h > bb_middle_4h > supertrend_4h > parabolic_sar_4h > bb_lower_4h > kc_lower_4h > was_squeezed_4h)
            )
            ...
            # --- is_sell_indicator_3 ---
            is_sell_indicator_3 = (
                (bbw_1h > ichimoku_cloud_bottom_1h > bb_upper_1h > ema_200_1h > ema_100_1h > ema_50_1h > ichimoku_base_1h > kc_upper_1h > ichimoku_cloud_top_1h > supertrend_1h > bb_middle_1h > ema_20_1h > kc_middle_1h > parabolic_sar_1h > ichimoku_conversion_1h > kc_lower_1h > bb_lower_1h > was_squeezed_1h) and 
                (bbw_2h > bb_upper_2h > ichimoku_base_2h > ichimoku_cloud_bottom_2h > ema_200_2h > kc_upper_2h > ema_100_2h > ema_50_2h > bb_middle_2h > ichimoku_cloud_top_2h > supertrend_2h > ema_20_2h > kc_middle_2h > parabolic_sar_2h > ichimoku_conversion_2h > kc_lower_2h > bb_lower_2h > was_squeezed_2h) and 
                (bbw_4h > bb_upper_4h > ema_200_4h > kc_upper_4h > parabolic_sar_4h > ichimoku_base_4h > ichimoku_cloud_bottom_4h > ema_100_4h > bb_middle_4h > supertrend_4h > ichimoku_cloud_top_4h > ema_50_4h > ema_20_4h > kc_middle_4h > ichimoku_conversion_4h > kc_lower_4h > bb_lower_4h > was_squeezed_4h)
            )

            # --- is_sell_indicator_4 ---
            is_sell_indicator_4 = (
                (ema_200_1h > ichimoku_base_1h > ichimoku_cloud_bottom_1h > ema_100_1h > kc_upper_1h > ichimoku_cloud_top_1h > ema_50_1h > bb_upper_1h > ema_20_1h > kc_middle_1h > bb_middle_1h > ichimoku_conversion_1h > bb_lower_1h > parabolic_sar_1h > kc_lower_1h > supertrend_1h > bbw_1h > was_squeezed_1h) and 
                (bbw_2h > ichimoku_cloud_bottom_2h > bb_upper_2h > ema_200_2h > ema_100_2h > kc_upper_2h > ichimoku_base_2h > ema_50_2h > ichimoku_cloud_top_2h > bb_middle_2h > ema_20_2h > kc_middle_2h > ichimoku_conversion_2h > parabolic_sar_2h > kc_lower_2h > bb_lower_2h > supertrend_2h > was_squeezed_2h) and 
                (bbw_4h > bb_upper_4h > ichimoku_base_4h > ichimoku_cloud_bottom_4h > kc_upper_4h > ichimoku_cloud_top_4h > ema_100_4h > ema_50_4h > ema_200_4h > ichimoku_conversion_4h > ema_20_4h > kc_middle_4h > bb_middle_4h > parabolic_sar_4h > kc_lower_4h > bb_lower_4h > supertrend_4h > was_squeezed_4h)
            )

            # --- is_sell_indicator_5 ---
            is_sell_indicator_5 = (
                (bbw_1h > ichimoku_base_1h > ichimoku_cloud_bottom_1h > ichimoku_cloud_top_1h > bb_upper_1h > supertrend_1h > kc_upper_1h > ema_50_1h > ema_100_1h > bb_middle_1h > ema_20_1h > kc_middle_1h > ema_200_1h > parabolic_sar_1h > ichimoku_conversion_1h > kc_lower_1h > bb_lower_1h > was_squeezed_1h) and 
                (bbw_2h > ichimoku_base_2h > ichimoku_cloud_bottom_2h > bb_upper_2h > supertrend_2h > ichimoku_cloud_top_2h > kc_upper_2h > bb_middle_2h > parabolic_sar_2h > ichimoku_conversion_2h > ema_20_2h > kc_middle_2h > ema_50_2h > ema_100_2h > ema_200_2h > kc_lower_2h > bb_lower_2h > was_squeezed_2h) and 
                (bbw_4h > parabolic_sar_4h > ichimoku_conversion_4h > ichimoku_cloud_top_4h > ichimoku_base_4h > ichimoku_cloud_bottom_4h > bb_upper_4h > supertrend_4h > kc_upper_4h > ema_20_4h > kc_middle_4h > bb_middle_4h > ema_50_4h > ema_100_4h > ema_200_4h > kc_lower_4h > bb_lower_4h > was_squeezed_4h)
            )

            # --- is_sell_indicator_6 ---
            is_sell_indicator_6 = (
                (bbw_1h > bb_upper_1h > ichimoku_base_1h > ichimoku_cloud_bottom_1h > ema_100_1h > kc_upper_1h > ema_50_1h > ichimoku_cloud_top_1h > supertrend_1h > ema_200_1h > bb_middle_1h > ema_20_1h > kc_middle_1h > ichimoku_conversion_1h > parabolic_sar_1h > kc_lower_1h > bb_lower_1h > was_squeezed_1h) and 
                (bbw_2h > bb_upper_2h > kc_upper_2h > ichimoku_base_2h > ichimoku_cloud_bottom_2h > bb_middle_2h > ichimoku_cloud_top_2h > ema_50_2h > ema_20_2h > kc_middle_2h > ema_100_2h > ichimoku_conversion_2h > ema_200_2h > kc_lower_2h > parabolic_sar_2h > bb_lower_2h > supertrend_2h > was_squeezed_2h) and 
                (bbw_4h > bb_upper_4h > kc_upper_4h > ichimoku_cloud_bottom_4h > ichimoku_base_4h > ichimoku_cloud_top_4h > ichimoku_conversion_4h > bb_middle_4h > ema_20_4h > kc_middle_4h > ema_50_4h > ema_100_4h > parabolic_sar_4h > ema_200_4h > kc_lower_4h > bb_lower_4h > supertrend_4h > was_squeezed_4h)
            )

            # --- is_sell_indicator_7 ---
            is_sell_indicator_7 = (
                (bbw_1h > ema_200_1h > ichimoku_cloud_bottom_1h > bb_upper_1h > ema_100_1h > kc_upper_1h > ema_50_1h > supertrend_1h > ichimoku_base_1h > bb_middle_1h > ema_20_1h > kc_middle_1h > parabolic_sar_1h > ichimoku_cloud_top_1h > ichimoku_conversion_1h > kc_lower_1h > bb_lower_1h > was_squeezed_1h) and 
                (bbw_2h > ema_200_2h > ema_100_2h > bb_upper_2h > kc_upper_2h > ichimoku_base_2h > ichimoku_cloud_bottom_2h > ema_50_2h > ichimoku_cloud_top_2h > bb_middle_2h > ema_20_2h > kc_middle_2h > ichimoku_conversion_2h > kc_lower_2h > parabolic_sar_2h > bb_lower_2h > supertrend_2h > was_squeezed_2h) and 
                (bbw_4h > ema_200_4h > ema_100_4h > bb_upper_4h > ema_50_4h > kc_upper_4h > ichimoku_cloud_bottom_4h > parabolic_sar_4h > ichimoku_base_4h > supertrend_4h > bb_middle_4h > ema_20_4h > kc_middle_4h > ichimoku_cloud_top_4h > ichimoku_conversion_4h > kc_lower_4h > bb_lower_4h > was_squeezed_4h)
            )

            # --- is_sell_indicator_8 ---
            is_sell_indicator_8 = (
                (bbw_1h > bb_upper_1h > ema_200_1h > kc_upper_1h > ema_100_1h > ichimoku_cloud_bottom_1h > supertrend_1h > ema_50_1h > bb_middle_1h > ichimoku_base_1h > parabolic_sar_1h > ema_20_1h > kc_middle_1h > ichimoku_cloud_top_1h > ichimoku_conversion_1h > kc_lower_1h > bb_lower_1h > was_squeezed_1h) and 
                (bbw_2h > ema_200_2h > bb_upper_2h > kc_upper_2h > ema_100_2h > ema_50_2h > ichimoku_base_2h > ichimoku_cloud_bottom_2h > bb_middle_2h > ichimoku_cloud_top_2h > ema_20_2h > kc_middle_2h > ichimoku_conversion_2h > kc_lower_2h > bb_lower_2h > parabolic_sar_2h > supertrend_2h > was_squeezed_2h) and 
                (bbw_4h > ema_200_4h > ema_100_4h > bb_upper_4h > kc_upper_4h > ema_50_4h > ichimoku_cloud_bottom_4h > bb_middle_4h > ichimoku_base_4h > ema_20_4h > kc_middle_4h > ichimoku_cloud_top_4h > ichimoku_conversion_4h > bb_lower_4h > kc_lower_4h > parabolic_sar_4h > supertrend_4h > was_squeezed_4h)
            )

            # --- is_sell_indicator_9 ---
            is_sell_indicator_9 = (
                (bbw_1h > bb_upper_1h > ema_200_1h > ema_100_1h > kc_upper_1h > ema_50_1h > ichimoku_cloud_bottom_1h > bb_middle_1h > ema_20_1h > kc_middle_1h > ichimoku_base_1h > ichimoku_cloud_top_1h > ichimoku_conversion_1h > kc_lower_1h > bb_lower_1h > parabolic_sar_1h > supertrend_1h > was_squeezed_1h) and 
                (bbw_2h > ema_200_2h > bb_upper_2h > kc_upper_2h > ema_100_2h > ema_50_2h > ichimoku_cloud_bottom_2h > parabolic_sar_2h > bb_middle_2h > ema_20_2h > kc_middle_2h > ichimoku_base_2h > supertrend_2h > ichimoku_cloud_top_2h > ichimoku_conversion_2h > kc_lower_2h > bb_lower_2h > was_squeezed_2h) and 
                (bbw_4h > ema_200_4h > bb_upper_4h > kc_upper_4h > ema_100_4h > ema_50_4h > parabolic_sar_4h > bb_middle_4h > supertrend_4h > ichimoku_base_4h > ichimoku_cloud_bottom_4h > ema_20_4h > kc_middle_4h > ichimoku_cloud_top_4h > ichimoku_conversion_4h > kc_lower_4h > bb_lower_4h > was_squeezed_4h)
            )

            # --- is_sell_indicator_10 ---
            is_sell_indicator_10 = (
                (bbw_1h > ema_200_1h > ema_100_1h > bb_upper_1h > kc_upper_1h > ema_50_1h > supertrend_1h > parabolic_sar_1h > ichimoku_cloud_bottom_1h > ichimoku_conversion_1h > ichimoku_base_1h > ichimoku_cloud_top_1h > bb_middle_1h > ema_20_1h > kc_middle_1h > bb_lower_1h > kc_lower_1h > was_squeezed_1h) and 
                (bbw_2h > ema_200_2h > ema_100_2h > parabolic_sar_2h > bb_upper_2h > kc_upper_2h > ichimoku_cloud_bottom_2h > ema_50_2h > supertrend_2h > ichimoku_base_2h > ichimoku_cloud_top_2h > ichimoku_conversion_2h > bb_middle_2h > ema_20_2h > kc_middle_2h > bb_lower_2h > kc_lower_2h > was_squeezed_2h) and 
                (bbw_4h > ema_200_4h > ema_100_4h > bb_upper_4h > ema_50_4h > kc_upper_4h > ichimoku_cloud_bottom_4h > parabolic_sar_4h > supertrend_4h > bb_middle_4h > ichimoku_base_4h > ema_20_4h > kc_middle_4h > ichimoku_cloud_top_4h > ichimoku_conversion_4h > kc_lower_4h > bb_lower_4h > was_squeezed_4h)
            )

            # --- is_sell_indicator_11 ---
            is_sell_indicator_11 = (
                (bbw_1h > ema_200_1h > ema_100_1h > kc_upper_1h > bb_upper_1h > ichimoku_cloud_bottom_1h > ema_50_1h > ichimoku_conversion_1h > ichimoku_base_1h > ichimoku_cloud_top_1h > bb_middle_1h > ema_20_1h > kc_middle_1h > bb_lower_1h > kc_lower_1h > parabolic_sar_1h > supertrend_1h > was_squeezed_1h) and 
                (bbw_2h > ema_200_2h > ema_100_2h > ichimoku_cloud_bottom_2h > bb_upper_2h > kc_upper_2h > ema_50_2h > parabolic_sar_2h > supertrend_2h > ichimoku_base_2h > bb_middle_2h > ema_20_2h > kc_middle_2h > ichimoku_cloud_top_2h > ichimoku_conversion_2h > kc_lower_2h > bb_lower_2h > was_squeezed_2h) and 
                (bbw_4h > ema_200_4h > ema_100_4h > ichimoku_cloud_bottom_4h > ema_50_4h > bb_upper_4h > kc_upper_4h > ichimoku_base_4h > supertrend_4h > bb_middle_4h > parabolic_sar_4h > ema_20_4h > kc_middle_4h > ichimoku_cloud_top_4h > ichimoku_conversion_4h > kc_lower_4h > bb_lower_4h > was_squeezed_4h)
            )

            # --- is_sell_indicator_12 ---
            is_sell_indicator_12 = (
                (bbw_1h > ema_200_1h > kc_upper_1h > ichimoku_conversion_1h > ichimoku_base_1h > ichimoku_cloud_top_1h > ichimoku_cloud_bottom_1h > supertrend_1h > bb_upper_1h > ema_100_1h > parabolic_sar_1h > ema_50_1h > bb_middle_1h > ema_20_1h > kc_middle_1h > bb_lower_1h > kc_lower_1h > was_squeezed_1h) and 
                (bbw_2h > ema_200_2h > ema_100_2h > parabolic_sar_2h > supertrend_2h > kc_upper_2h > ichimoku_cloud_bottom_2h > ichimoku_base_2h > ichimoku_cloud_top_2h > ichimoku_conversion_2h > ema_50_2h > bb_upper_2h > ema_20_2h > kc_middle_2h > bb_middle_2h > bb_lower_2h > kc_lower_2h > was_squeezed_2h) and 
                (bbw_4h > ema_200_4h > ichimoku_cloud_bottom_4h > ema_100_4h > parabolic_sar_4h > ema_50_4h > bb_upper_4h > kc_upper_4h > supertrend_4h > ichimoku_base_4h > ichimoku_cloud_top_4h > ichimoku_conversion_4h > bb_middle_4h > ema_20_4h > kc_middle_4h > kc_lower_4h > bb_lower_4h > was_squeezed_4h)
            )

            # --- is_sell_indicator_13 ---
            is_sell_indicator_13 = (
                (bbw_1h > ema_200_1h > ema_100_1h > bb_upper_1h > kc_upper_1h > supertrend_1h > ema_50_1h > ichimoku_cloud_bottom_1h > ichimoku_base_1h > bb_middle_1h > ema_20_1h > kc_middle_1h > parabolic_sar_1h > ichimoku_cloud_top_1h > ichimoku_conversion_1h > kc_lower_1h > bb_lower_1h > was_squeezed_1h) and 
                (bbw_2h > ema_200_2h > ema_100_2h > bb_upper_2h > kc_upper_2h > parabolic_sar_2h > ema_50_2h > supertrend_2h > ichimoku_cloud_bottom_2h > bb_middle_2h > ichimoku_base_2h > ema_20_2h > kc_middle_2h > ichimoku_cloud_top_2h > ichimoku_conversion_2h > kc_lower_2h > bb_lower_2h > was_squeezed_2h) and 
                (bbw_4h > ema_200_4h > ema_100_4h > bb_upper_4h > ema_50_4h > kc_upper_4h > ichimoku_cloud_bottom_4h > parabolic_sar_4h > supertrend_4h > bb_middle_4h > ichimoku_base_4h > ema_20_4h > kc_middle_4h > ichimoku_cloud_top_4h > ichimoku_conversion_4h > kc_lower_4h > bb_lower_4h > was_squeezed_4h)
            )

            # --- is_sell_indicator_14 ---
            is_sell_indicator_14 = (
                (bbw_1h > ema_200_1h > bb_upper_1h > ema_100_1h > ema_50_1h > kc_upper_1h > ichimoku_cloud_bottom_1h > bb_middle_1h > ichimoku_base_1h > parabolic_sar_1h > ema_20_1h > kc_middle_1h > ichimoku_cloud_top_1h > supertrend_1h > ichimoku_conversion_1h > kc_lower_1h > bb_lower_1h > was_squeezed_1h) and 
                (bbw_2h > ema_200_2h > ema_100_2h > bb_upper_2h > ema_50_2h > kc_upper_2h > ichimoku_cloud_bottom_2h > parabolic_sar_2h > bb_middle_2h > ema_20_2h > kc_middle_2h > ichimoku_base_2h > supertrend_2h > ichimoku_cloud_top_2h > ichimoku_conversion_2h > kc_lower_2h > bb_lower_2h > was_squeezed_2h) and 
                (bbw_4h > ichimoku_cloud_bottom_4h > ema_200_4h > ema_100_4h > ema_50_4h > bb_upper_4h > kc_upper_4h > bb_middle_4h > ema_20_4h > kc_middle_4h > ichimoku_base_4h > ichimoku_cloud_top_4h > ichimoku_conversion_4h > kc_lower_4h > bb_lower_4h > parabolic_sar_4h > was_squeezed_4h > supertrend_4h)
            )

            # --- is_sell_indicator_15 ---
            is_sell_indicator_15 = (
                (bbw_1h > ema_200_1h > ema_100_1h > bb_upper_1h > kc_upper_1h > ema_50_1h > ichimoku_cloud_bottom_1h > supertrend_1h > bb_middle_1h > ema_20_1h > kc_middle_1h > ichimoku_base_1h > parabolic_sar_1h > ichimoku_cloud_top_1h > ichimoku_conversion_1h > kc_lower_1h > bb_lower_1h > was_squeezed_1h) and 
                (bbw_2h > ema_200_2h > ema_100_2h > bb_upper_2h > ema_50_2h > ichimoku_cloud_bottom_2h > kc_upper_2h > supertrend_2h > parabolic_sar_2h > bb_middle_2h > ema_20_2h > kc_middle_2h > ichimoku_base_2h > ichimoku_cloud_top_2h > ichimoku_conversion_2h > kc_lower_2h > bb_lower_2h > was_squeezed_2h) and 
                (bbw_4h > ema_200_4h > ema_100_4h > bb_upper_4h > ema_50_4h > ichimoku_cloud_bottom_4h > kc_upper_4h > ichimoku_base_4h > bb_middle_4h > ema_20_4h > kc_middle_4h > supertrend_4h > parabolic_sar_4h > ichimoku_cloud_top_4h > ichimoku_conversion_4h > kc_lower_4h > bb_lower_4h > was_squeezed_4h)
            )

            # --- is_sell_indicator_16 ---
            is_sell_indicator_16 = (
                (bbw_1h > ema_200_1h > ema_100_1h > bb_upper_1h > kc_upper_1h > ema_50_1h > ichimoku_cloud_bottom_1h > parabolic_sar_1h > supertrend_1h > bb_middle_1h > ema_20_1h > kc_middle_1h > ichimoku_base_1h > ichimoku_cloud_top_1h > ichimoku_conversion_1h > kc_lower_1h > bb_lower_1h > was_squeezed_1h) and 
                (bbw_2h > ema_200_2h > ema_100_2h > bb_upper_2h > ema_50_2h > kc_upper_2h > ichimoku_cloud_bottom_2h > bb_middle_2h > parabolic_sar_2h > ema_20_2h > kc_middle_2h > supertrend_2h > ichimoku_base_2h > ichimoku_cloud_top_2h > ichimoku_conversion_2h > kc_lower_2h > bb_lower_2h > was_squeezed_2h) and 
                (bbw_4h > ema_200_4h > ema_100_4h > bb_upper_4h > ema_50_4h > kc_upper_4h > ichimoku_cloud_bottom_4h > bb_middle_4h > ema_20_4h > kc_middle_4h > ichimoku_base_4h > parabolic_sar_4h > supertrend_4h > ichimoku_cloud_top_4h > ichimoku_conversion_4h > kc_lower_4h > bb_lower_4h > was_squeezed_4h)
            )

            # --- is_sell_indicator_17 ---
            is_sell_indicator_17 = (
                (bbw_1h > ema_200_1h > ichimoku_cloud_bottom_1h > ema_100_1h > supertrend_1h > kc_upper_1h > parabolic_sar_1h > ema_50_1h > bb_upper_1h > ichimoku_base_1h > ichimoku_cloud_top_1h > ema_20_1h > kc_middle_1h > bb_middle_1h > ichimoku_conversion_1h > bb_lower_1h > kc_lower_1h > was_squeezed_1h) and 
                (bbw_2h > ema_200_2h > ema_100_2h > ichimoku_cloud_bottom_2h > kc_upper_2h > supertrend_2h > ichimoku_base_2h > ema_50_2h > bb_upper_2h > ichimoku_cloud_top_2h > parabolic_sar_2h > ema_20_2h > kc_middle_2h > bb_middle_2h > ichimoku_conversion_2h > bb_lower_2h > kc_lower_2h > was_squeezed_2h) and 
                (bbw_4h > ema_200_4h > bb_upper_4h > ema_100_4h > kc_upper_4h > supertrend_4h > ema_50_4h > ichimoku_base_4h > ichimoku_cloud_bottom_4h > bb_middle_4h > ichimoku_cloud_top_4h > parabolic_sar_4h > ema_20_4h > kc_middle_4h > ichimoku_conversion_4h > kc_lower_4h > bb_lower_4h > was_squeezed_4h)
            )

            # --- is_sell_indicator_18 ---
            is_sell_indicator_18 = (
                (bbw_1h > ema_200_1h > ema_100_1h > bb_upper_1h > ichimoku_cloud_bottom_1h > ema_50_1h > kc_upper_1h > bb_middle_1h > ichimoku_base_1h > ema_20_1h > kc_middle_1h > ichimoku_cloud_top_1h > ichimoku_conversion_1h > kc_lower_1h > bb_lower_1h > parabolic_sar_1h > supertrend_1h > was_squeezed_1h) and 
                (bbw_2h > ema_200_2h > ema_100_2h > bb_upper_2h > ichimoku_cloud_bottom_2h > ema_50_2h > kc_upper_2h > ichimoku_base_2h > bb_middle_2h > ema_20_2h > kc_middle_2h > ichimoku_cloud_top_2h > ichimoku_conversion_2h > kc_lower_2h > bb_lower_2h > parabolic_sar_2h > supertrend_2h > was_squeezed_2h) and 
                (bbw_4h > ema_200_4h > ema_100_4h > ema_50_4h > ichimoku_cloud_bottom_4h > bb_upper_4h > kc_upper_4h > ichimoku_base_4h > ema_20_4h > kc_middle_4h > bb_middle_4h > ichimoku_cloud_top_4h > ichimoku_conversion_4h > kc_lower_4h > bb_lower_4h > parabolic_sar_4h > was_squeezed_4h > supertrend_4h)
            )

            # --- is_sell_indicator_19 ---
            is_sell_indicator_19 = (
                (bbw_1h > ema_200_1h > ema_100_1h > bb_upper_1h > kc_upper_1h > ema_50_1h > supertrend_1h > ichimoku_cloud_bottom_1h > parabolic_sar_1h > bb_middle_1h > ema_20_1h > kc_middle_1h > ichimoku_base_1h > ichimoku_cloud_top_1h > ichimoku_conversion_1h > bb_lower_1h > kc_lower_1h > was_squeezed_1h) and 
                (bbw_2h > ema_200_2h > ema_100_2h > bb_upper_2h > ichimoku_cloud_bottom_2h > kc_upper_2h > ema_50_2h > supertrend_2h > parabolic_sar_2h > bb_middle_2h > ema_20_2h > kc_middle_2h > ichimoku_base_2h > ichimoku_cloud_top_2h > ichimoku_conversion_2h > kc_lower_2h > bb_lower_2h > was_squeezed_2h) and 
                (bbw_4h > ema_200_4h > ema_100_4h > bb_upper_4h > kc_upper_4h > ema_50_4h > ichimoku_cloud_bottom_4h > ichimoku_base_4h > supertrend_4h > bb_middle_4h > parabolic_sar_4h > ichimoku_cloud_top_4h > ema_20_4h > kc_middle_4h > ichimoku_conversion_4h > kc_lower_4h > bb_lower_4h > was_squeezed_4h)
            )

            # --- is_sell_indicator_20 ---
            is_sell_indicator_20 = (
                (bbw_1h > ema_200_1h > ema_100_1h > bb_upper_1h > kc_upper_1h > ema_50_1h > ichimoku_base_1h > ichimoku_cloud_top_1h > ichimoku_cloud_bottom_1h > supertrend_1h > parabolic_sar_1h > bb_middle_1h > ema_20_1h > kc_middle_1h > ichimoku_conversion_1h > kc_lower_1h > bb_lower_1h > was_squeezed_1h) and 
                (bbw_2h > ema_200_2h > ema_100_2h > bb_upper_2h > kc_upper_2h > ema_50_2h > ichimoku_cloud_bottom_2h > parabolic_sar_2h > supertrend_2h > bb_middle_2h > ema_20_2h > kc_middle_2h > ichimoku_base_2h > ichimoku_cloud_top_2h > ichimoku_conversion_2h > kc_lower_2h > bb_lower_2h > was_squeezed_2h) and 
                (bbw_4h > ema_200_4h > ema_100_4h > ichimoku_cloud_bottom_4h > bb_upper_4h > ema_50_4h > kc_upper_4h > ichimoku_base_4h > parabolic_sar_4h > supertrend_4h > bb_middle_4h > ema_20_4h > kc_middle_4h > ichimoku_cloud_top_4h > ichimoku_conversion_4h > bb_lower_4h > kc_lower_4h > was_squeezed_4h)
            )

            # --- is_sell_indicator_21 ---
            is_sell_indicator_21 = (
                (bbw_1h > ema_200_1h > bb_upper_1h > ema_100_1h > kc_upper_1h > ema_50_1h > ichimoku_cloud_bottom_1h > supertrend_1h > ichimoku_base_1h > parabolic_sar_1h > bb_middle_1h > ema_20_1h > kc_middle_1h > ichimoku_cloud_top_1h > ichimoku_conversion_1h > kc_lower_1h > bb_lower_1h > was_squeezed_1h) and 
                (bbw_2h > ema_200_2h > bb_upper_2h > ema_100_2h > kc_upper_2h > ichimoku_cloud_bottom_2h > ema_50_2h > parabolic_sar_2h > supertrend_2h > bb_middle_2h > ema_20_2h > kc_middle_2h > ichimoku_base_2h > ichimoku_cloud_top_2h > ichimoku_conversion_2h > kc_lower_2h > bb_lower_2h > was_squeezed_2h) and 
                (bbw_4h > ema_200_4h > bb_upper_4h > ema_100_4h > kc_upper_4h > ichimoku_cloud_bottom_4h > ema_50_4h > parabolic_sar_4h > supertrend_4h > bb_middle_4h > ema_20_4h > kc_middle_4h > ichimoku_base_4h > ichimoku_cloud_top_4h > ichimoku_conversion_4h > kc_lower_4h > bb_lower_4h > was_squeezed_4h)
            )

            # --- is_sell_indicator_22 ---
            is_sell_indicator_22 = (
                (bbw_1h > ichimoku_cloud_bottom_1h > ema_200_1h > bb_upper_1h > ema_100_1h > kc_upper_1h > ema_50_1h > bb_middle_1h > ichimoku_base_1h > ema_20_1h > kc_middle_1h > ichimoku_cloud_top_1h > ichimoku_conversion_1h > kc_lower_1h > parabolic_sar_1h > bb_lower_1h > supertrend_1h > was_squeezed_1h) and 
                (bbw_2h > bb_upper_2h > ema_200_2h > ichimoku_base_2h > ichimoku_cloud_bottom_2h > kc_upper_2h > ema_100_2h > ema_50_2h > ichimoku_cloud_top_2h > bb_middle_2h > ema_20_2h > kc_middle_2h > ichimoku_conversion_2h > kc_lower_2h > bb_lower_2h > parabolic_sar_2h > was_squeezed_2h > supertrend_2h) and 
                (bbw_4h > ema_200_4h > bb_upper_4h > ichimoku_cloud_bottom_4h > kc_upper_4h > supertrend_4h > ema_100_4h > ichimoku_base_4h > ema_50_4h > parabolic_sar_4h > bb_middle_4h > ichimoku_cloud_top_4h > ema_20_4h > kc_middle_4h > ichimoku_conversion_4h > bb_lower_4h > kc_lower_4h > was_squeezed_4h)
            )

            # --- is_sell_indicator_23 ---
            is_sell_indicator_23 = (
                (bbw_1h > ema_200_1h > ema_100_1h > bb_upper_1h > kc_upper_1h > ema_50_1h > ichimoku_cloud_bottom_1h > supertrend_1h > ichimoku_conversion_1h > ichimoku_base_1h > ichimoku_cloud_top_1h > parabolic_sar_1h > bb_middle_1h > ema_20_1h > kc_middle_1h > bb_lower_1h > kc_lower_1h > was_squeezed_1h) and 
                (bbw_2h > ema_200_2h > ema_100_2h > ema_50_2h > ichimoku_cloud_bottom_2h > parabolic_sar_2h > kc_upper_2h > supertrend_2h > bb_upper_2h > ichimoku_base_2h > ichimoku_cloud_top_2h > ema_20_2h > kc_middle_2h > ichimoku_conversion_2h > bb_middle_2h > bb_lower_2h > kc_lower_2h > was_squeezed_2h) and 
                (bbw_4h > ema_200_4h > ema_100_4h > ichimoku_cloud_bottom_4h > ema_50_4h > bb_upper_4h > kc_upper_4h > ichimoku_base_4h > supertrend_4h > parabolic_sar_4h > ema_20_4h > kc_middle_4h > bb_middle_4h > ichimoku_cloud_top_4h > ichimoku_conversion_4h > kc_lower_4h > bb_lower_4h > was_squeezed_4h)
            )

            # --- is_sell_indicator_24 ---
            is_sell_indicator_24 = (
                (ema_200_1h > kc_upper_1h > ichimoku_cloud_bottom_1h > bb_upper_1h > ema_100_1h > ema_50_1h > ichimoku_base_1h > bb_middle_1h > ema_20_1h > kc_middle_1h > ichimoku_cloud_top_1h > ichimoku_conversion_1h > bb_lower_1h > parabolic_sar_1h > kc_lower_1h > supertrend_1h > bbw_1h > was_squeezed_1h) and 
                (ema_200_2h > ichimoku_cloud_bottom_2h > ema_100_2h > kc_upper_2h > bb_upper_2h > supertrend_2h > ichimoku_base_2h > ema_50_2h > parabolic_sar_2h > ichimoku_cloud_top_2h > bb_middle_2h > ema_20_2h > kc_middle_2h > ichimoku_conversion_2h > bb_lower_2h > kc_lower_2h > bbw_2h > was_squeezed_2h) and 
                (ema_200_4h > ema_100_4h > kc_upper_4h > bb_upper_4h > ema_50_4h > supertrend_4h > ichimoku_base_4h > ichimoku_cloud_bottom_4h > bbw_4h > parabolic_sar_4h > bb_middle_4h > ichimoku_cloud_top_4h > ema_20_4h > kc_middle_4h > ichimoku_conversion_4h > bb_lower_4h > kc_lower_4h > was_squeezed_4h)
            )

            # --- إدراج_شروط_مؤشرات_بيع ---            
  
            # --- تقييم_is_buy_indicator_5 ---
            if is_buy_indicator_5:
                score += 50
                reasons.append("ترتيب إيجابي للمؤشرات (PUMP) 5")

            # --- تقييم_is_buy_indicator_6 ---
            elif is_buy_indicator_6:
                score += 50
                reasons.append("ترتيب إيجابي للمؤشرات (PUMP) 6")

            # --- تقييم_is_buy_indicator_7 ---
            elif is_buy_indicator_7:
                score += 50
                reasons.append("ترتيب إيجابي للمؤشرات (PUMP) 7")

            # --- تقييم_is_buy_indicator_8 ---
            elif is_buy_indicator_8:
                score += 50
                reasons.append("ترتيب إيجابي للمؤشرات (PUMP) 8")

            # --- تقييم_is_buy_indicator_9 ---
            elif is_buy_indicator_9:
                score += 50
                reasons.append("ترتيب إيجابي للمؤشرات (PUMP) 9")

            # --- تقييم_is_buy_indicator_10 ---
            elif is_buy_indicator_10:
                score += 50
                reasons.append("ترتيب إيجابي للمؤشرات (PUMP) 10")

            # --- تقييم_is_buy_indicator_11 ---
            elif is_buy_indicator_11:
                score += 50
                reasons.append("ترتيب إيجابي للمؤشرات (PUMP) 11")

            # --- تقييم_is_buy_indicator_12 ---
            elif is_buy_indicator_12:
                score += 50
                reasons.append("ترتيب إيجابي للمؤشرات (PUMP) 12")

            # --- تقييم_is_buy_indicator_13 ---
            elif is_buy_indicator_13:
                score += 50
                reasons.append("ترتيب إيجابي للمؤشرات (PUMP) 13")

            # --- تقييم_is_buy_indicator_14 ---
            elif is_buy_indicator_14:
                score += 50
                reasons.append("ترتيب إيجابي للمؤشرات (PUMP) 14")

            # --- تقييم_is_buy_indicator_15 ---
            elif is_buy_indicator_15:
                score += 50
                reasons.append("ترتيب إيجابي للمؤشرات (PUMP) 15")

            # --- تقييم_is_buy_indicator_16 ---
            elif is_buy_indicator_16:
                score += 50
                reasons.append("ترتيب إيجابي للمؤشرات (PUMP) 16")

            # --- تقييم_is_buy_indicator_17 ---
            elif is_buy_indicator_17:
                score += 50
                reasons.append("ترتيب إيجابي للمؤشرات (PUMP) 17")

            # --- تقييم_is_buy_indicator_18 ---
            elif is_buy_indicator_18:
                score += 50
                reasons.append("ترتيب إيجابي للمؤشرات (PUMP) 18")

            # --- تقييم_is_buy_indicator_19 ---
            elif is_buy_indicator_19:
                score += 50
                reasons.append("ترتيب إيجابي للمؤشرات (PUMP) 19")

            # --- تقييم_is_buy_indicator_20 ---
            elif is_buy_indicator_20:
                score += 50
                reasons.append("ترتيب إيجابي للمؤشرات (PUMP) 20")

            # --- تقييم_is_buy_indicator_21 ---
            elif is_buy_indicator_21:
                score += 50
                reasons.append("ترتيب إيجابي للمؤشرات (PUMP) 21")

            # --- تقييم_is_buy_indicator_22 ---
            elif is_buy_indicator_22:
                score += 50
                reasons.append("ترتيب إيجابي للمؤشرات (PUMP) 22")

            # --- تقييم_is_buy_indicator_23 ---
            elif is_buy_indicator_23:
                score += 50
                reasons.append("ترتيب إيجابي للمؤشرات (PUMP) 23")

            # --- تقييم_is_buy_indicator_24 ---
            elif is_buy_indicator_24:
                score += 50
                reasons.append("ترتيب إيجابي للمؤشرات (PUMP) 24")

            # --- تقييم_is_buy_indicator_25 ---
            elif is_buy_indicator_25:
                score += 50
                reasons.append("ترتيب إيجابي للمؤشرات (PUMP) 25")

            # --- تقييم_is_buy_indicator_26 ---
            elif is_buy_indicator_26:
                score += 50
                reasons.append("ترتيب إيجابي للمؤشرات (PUMP) 26")

            # --- تقييم_is_buy_indicator_27 ---
            elif is_buy_indicator_27:
                score += 50
                reasons.append("ترتيب إيجابي للمؤشرات (PUMP) 27")

            # --- تقييم_is_buy_indicator_28 ---
            elif is_buy_indicator_28:
                score += 50
                reasons.append("ترتيب إيجابي للمؤشرات (PUMP) 28")

            # --- تقييم_is_buy_indicator_29 ---
            elif is_buy_indicator_29:
                score += 50
                reasons.append("ترتيب إيجابي للمؤشرات (PUMP) 29")

            # --- تقييم_is_buy_indicator_30 ---
            elif is_buy_indicator_30:
                score += 50
                reasons.append("ترتيب إيجابي للمؤشرات (PUMP) 30")

            # --- تقييم_is_buy_indicator_31 ---
            elif is_buy_indicator_31:
                score += 50
                reasons.append("ترتيب إيجابي للمؤشرات (PUMP) 31")

            # --- تقييم_is_buy_indicator_32 ---
            elif is_buy_indicator_32:
                score += 50
                reasons.append("ترتيب إيجابي للمؤشرات (PUMP) 32")

            # --- تقييم_is_buy_indicator_33 ---
            elif is_buy_indicator_33:
                score += 50
                reasons.append("ترتيب إيجابي للمؤشرات (PUMP) 33")

            # --- تقييم_is_buy_indicator_34 ---
            elif is_buy_indicator_34:
                score += 50
                reasons.append("ترتيب إيجابي للمؤشرات (PUMP) 34")

            # --- تقييم_is_buy_indicator_35 ---
            elif is_buy_indicator_35:
                score += 50
                reasons.append("ترتيب إيجابي للمؤشرات (PUMP) 35")

            # --- تقييم_is_buy_indicator_36 ---
            elif is_buy_indicator_36:
                score += 50
                reasons.append("ترتيب إيجابي للمؤشرات (PUMP) 36")

            # --- تقييم_is_buy_indicator_37 ---
            elif is_buy_indicator_37:
                score += 50
                reasons.append("ترتيب إيجابي للمؤشرات (PUMP) 37")

            # --- تقييم_is_buy_indicator_38 ---
            elif is_buy_indicator_38:
                score += 50
...
async def intelligence_scanner3():
    """
    الرادار v11.1 (عين الصقر + القلعة المحصنة + فلتر الماكد)
    يدمج الدعوم والمقاومات المتعددة الفريمات، يتجاهل العملات الميتة والمزعجة، 
    ويضرب بيد من حديد في مناطق انضغاط السيولة وإبادة البائعين بتأكيد فني صارم.
    ...
    try:
        ...
        for coin in coins:
            ...
            # --- is_buy_momentum_1 ---
            is_buy_momentum_1 = (
                (rsi_1h >= 78 and macd_1h >= 1 and macd_signal_1h >= 5 and macd_hist_1h >= 1 and obv_1h >= 1 and obv_slope_1h >= 7 and adx_1h >= 75 and stochastic_k_1h >= 33 and stochastic_d_1h >= 23 and williams_r_1h <= -19) and 
                (rsi_2h >= 80 and macd_2h >= 1 and macd_signal_2h >= 4 and macd_hist_2h >= 1 and obv_2h >= 9 and obv_slope_2h >= 7 and adx_2h >= 75 and stochastic_k_2h >= 44 and stochastic_d_2h >= 54 and williams_r_2h <= -18)
            )

            # --- is_buy_momentum_2 ---
            is_buy_momentum_2 = (
                (rsi_1h >= 90 and macd_1h >= 3 and macd_signal_1h >= 7 and macd_hist_1h >= 2 and obv_1h >= 4 and obv_slope_1h >= 2 and adx_1h >= 87 and stochastic_k_1h >= 64 and stochastic_d_1h >= 54 and williams_r_1h <= -37) and 
                (rsi_2h >= 88 and macd_2h >= 3 and macd_signal_2h >= 3 and macd_hist_2h >= 2 and obv_2h >= 3 and obv_slope_2h >= 2 and adx_2h >= 89 and stochastic_k_2h >= 63 and stochastic_d_2h >= 52 and williams_r_2h <= -24) and 
                (rsi_4h >= 84 and macd_4h >= 2 and macd_signal_4h >= 2 and macd_hist_4h >= 2 and obv_4h >= 3 and obv_slope_4h >= 2 and adx_4h >= 77 and stochastic_k_4h >= 58 and stochastic_d_4h >= 38 and williams_r_4h <= -24)
            )

            # --- is_buy_momentum_3 ---
            is_buy_momentum_3 = (
                (rsi_1h >= 87 and macd_1h >= 7 and macd_signal_1h >= 3 and macd_hist_1h >= 4 and obv_1h >= 8 and obv_slope_1h >= 6 and adx_1h >= 91 and stochastic_k_1h >= 71 and stochastic_d_1h >= 75 and williams_r_1h <= -49) and 
                (rsi_2h >= 85 and macd_2h >= 7 and macd_signal_2h >= 3 and macd_hist_2h >= 4 and obv_2h >= 5 and obv_slope_2h >= 6 and adx_2h >= 87 and stochastic_k_2h >= 77 and stochastic_d_2h >= 75 and williams_r_2h <= -46) and 
                (rsi_4h >= 87 and macd_4h >= 1 and macd_signal_4h >= 7 and macd_hist_4h >= 5 and obv_4h >= 5 and obv_slope_4h >= 7 and adx_4h >= 75 and stochastic_k_4h >= 69 and stochastic_d_4h >= 60 and williams_r_4h <= -26)
            )

            # --- is_buy_momentum_4 ---
            is_buy_momentum_4 = (
                (rsi_1h >= 80 and macd_1h >= 5 and macd_signal_1h >= 5 and macd_hist_1h >= 3 and obv_1h >= 1 and obv_slope_1h >= 2 and adx_1h >= 62 and stochastic_k_1h >= 84 and stochastic_d_1h >= 84 and williams_r_1h <= -4) and 
                (rsi_2h >= 75 and macd_2h >= 7 and macd_signal_2h >= 5 and macd_hist_2h >= 2 and obv_2h >= 1 and obv_slope_2h >= 3 and adx_2h >= 97 and stochastic_k_2h >= 96 and stochastic_d_2h >= 93 and williams_r_2h <= -1) and 
                (rsi_4h >= 69 and macd_4h >= 8 and macd_signal_4h >= 5 and macd_hist_4h >= 2 and obv_4h >= 2 and obv_slope_4h >= 4 and adx_4h >= 77 and stochastic_k_4h >= 93 and stochastic_d_4h >= 91 and williams_r_4h <= -3)
            )

            # --- is_buy_momentum_5 ---
            is_buy_momentum_5 = (
                (rsi_1h >= 87 and macd_1h >= 2 and macd_signal_1h <= -1 and macd_hist_1h >= 2 and obv_1h >= 2 and obv_slope_1h >= 3 and adx_1h >= 84 and stochastic_k_1h >= 33 and stochastic_d_1h >= 28 and williams_r_1h <= -29) and 
                (rsi_2h >= 83 and macd_2h >= 2 and macd_signal_2h >= 5 and macd_hist_2h >= 2 and obv_2h >= 1 and obv_slope_2h >= 4 and adx_2h >= 74 and stochastic_k_2h >= 35 and stochastic_d_2h >= 29 and williams_r_2h <= -33) and 
                (rsi_4h >= 79 and macd_4h >= 2 and macd_signal_4h >= 4 and macd_hist_4h >= 2 and obv_4h <= -2 and obv_slope_4h >= 4 and adx_4h >= 67 and stochastic_k_4h >= 33 and stochastic_d_4h >= 31 and williams_r_4h <= -33)
            )

            # --- is_buy_momentum_6 ---
            is_buy_momentum_6 = (
                (rsi_1h >= 64 and macd_1h >= 2 and macd_signal_1h >= 2 and macd_hist_1h >= 3 and obv_1h >= 1 and obv_slope_1h >= 2 and adx_1h >= 45 and stochastic_k_1h >= 69 and stochastic_d_1h >= 71 and williams_r_1h <= -20) and 
                (rsi_2h >= 65 and macd_2h >= 3 and macd_signal_2h >= 2 and macd_hist_2h >= 5 and obv_2h >= 6 and obv_slope_2h >= 3 and adx_2h >= 71 and stochastic_k_2h >= 77 and stochastic_d_2h >= 80 and williams_r_2h <= -22) and 
                (rsi_4h >= 66 and macd_4h >= 4 and macd_signal_4h >= 4 and macd_hist_4h >= 6 and obv_4h >= 2 and obv_slope_4h >= 3 and adx_4h >= 50 and stochastic_k_4h >= 82 and stochastic_d_4h >= 80 and williams_r_4h <= -22)
            )

            # --- is_buy_momentum_7 ---
            is_buy_momentum_7 = (
                (rsi_1h >= 56 and macd_1h >= 2 and macd_signal_1h >= 3 and macd_hist_1h <= -5 and obv_1h >= 1 and obv_slope_1h >= 7 and adx_1h >= 24 and stochastic_k_1h >= 44 and stochastic_d_1h >= 43 and williams_r_1h <= -57) and 
                (rsi_2h >= 63 and macd_2h >= 4 and macd_signal_2h >= 4 and macd_hist_2h >= 5 and obv_2h >= 8 and obv_slope_2h >= 8 and adx_2h >= 60 and stochastic_k_2h >= 67 and stochastic_d_2h >= 72 and williams_r_2h <= -32) and 
                (rsi_4h >= 70 and macd_4h >= 4 and macd_signal_4h >= 2 and macd_hist_4h >= 1 and obv_4h >= 9 and obv_slope_4h <= -4 and adx_4h >= 69 and stochastic_k_4h >= 75 and stochastic_d_4h >= 75 and williams_r_4h <= -29)
            )

            # --- is_buy_momentum_8 ---
            is_buy_momentum_8 = (
                (rsi_1h >= 75 and macd_1h >= 1 and macd_signal_1h >= 1 and macd_hist_1h >= 4 and obv_1h >= 1 and obv_slope_1h >= 5 and adx_1h >= 81 and stochastic_k_1h >= 78 and stochastic_d_1h >= 77 and williams_r_1h <= -28) and 
                (rsi_2h >= 75 and macd_2h >= 1 and macd_signal_2h >= 9 and macd_hist_2h >= 6 and obv_2h >= 2 and obv_slope_2h >= 6 and adx_2h >= 79 and stochastic_k_2h >= 73 and stochastic_d_2h >= 76 and williams_r_2h <= -30) and 
                (rsi_4h >= 76 and macd_4h >= 1 and macd_signal_4h >= 1 and macd_hist_4h >= 6 and obv_4h >= 2 and obv_slope_4h >= 6 and adx_4h >= 84 and stochastic_k_4h >= 75 and stochastic_d_4h >= 61 and williams_r_4h <= -29)
            )

            # --- is_buy_momentum_9 ---
            is_buy_momentum_9 = (
                (rsi_1h >= 84 and macd_1h >= 1 and macd_signal_1h >= 4 and macd_hist_1h >= 7 and obv_1h >= 1 and obv_slope_1h <= -7 and adx_1h >= 95 and stochastic_k_1h >= 72 and stochastic_d_1h >= 76 and williams_r_1h <= -27) and 
                (rsi_2h >= 94 and macd_2h >= 8 and macd_signal_2h >= 3 and macd_hist_2h >= 5 and obv_2h >= 1 and obv_slope_2h >= 1 and adx_2h >= 92 and stochastic_k_2h >= 74 and stochastic_d_2h >= 72 and williams_r_2h <= -27) and 
                (rsi_4h >= 91 and macd_4h >= 8 and macd_signal_4h >= 3 and macd_hist_4h >= 5 and obv_4h >= 2 and obv_slope_4h >= 2 and adx_4h >= 97 and stochastic_k_4h >= 68 and stochastic_d_4h >= 61 and williams_r_4h <= -31)
            )

            # --- is_buy_momentum_10 ---
            is_buy_momentum_10 = (
                (rsi_1h >= 66 and macd_1h >= 9 and macd_signal_1h >= 8 and macd_hist_1h >= 1 and obv_1h >= 3 and obv_slope_1h >= 3 and adx_1h >= 50 and stochastic_k_1h >= 72 and stochastic_d_1h >= 69 and williams_r_1h <= -26) and 
                (rsi_4h >= 71 and macd_4h >= 1 and macd_signal_4h >= 1 and macd_hist_4h >= 4 and obv_4h >= 4 and obv_slope_4h >= 1 and adx_4h >= 79 and stochastic_k_4h >= 79 and stochastic_d_4h >= 73 and williams_r_4h <= -15)
            )

            # --- is_buy_momentum_11 ---
            is_buy_momentum_11 = (
                (rsi_1h >= 59 and macd_1h >= 7 and macd_signal_1h >= 7 and macd_hist_1h >= 1 and obv_1h >= 4 and obv_slope_1h <= -7 and adx_1h >= 62 and stochastic_k_1h >= 50 and stochastic_d_1h >= 50 and williams_r_1h <= -52) and 
                (rsi_2h >= 63 and macd_2h >= 7 and macd_signal_2h >= 5 and macd_hist_2h >= 2 and obv_2h >= 8 and obv_slope_2h <= -8 and adx_2h >= 83 and stochastic_k_2h >= 50 and stochastic_d_2h >= 53 and williams_r_2h <= -51) and 
                (rsi_4h >= 66 and macd_4h >= 6 and macd_signal_4h >= 2 and macd_hist_4h >= 3 and obv_4h >= 6 and obv_slope_4h >= 3 and adx_4h >= 88 and stochastic_k_4h >= 63 and stochastic_d_4h >= 77 and williams_r_4h <= -48)
            )

            # --- is_buy_momentum_12 ---
            is_buy_momentum_12 = (
                (rsi_1h >= 65 and macd_1h >= 2 and macd_signal_1h >= 3 and macd_hist_1h <= -3 and obv_1h >= 8 and obv_slope_1h >= 2 and adx_1h >= 72 and stochastic_k_1h >= 28 and stochastic_d_1h >= 37 and williams_r_1h <= -68) and 
                (rsi_2h >= 70 and macd_2h >= 4 and macd_signal_2h >= 3 and macd_hist_2h >= 8 and obv_2h >= 1 and obv_slope_2h >= 3 and adx_2h >= 83 and stochastic_k_2h >= 60 and stochastic_d_2h >= 61 and williams_r_2h <= -37) and 
                (rsi_4h >= 70 and macd_4h >= 3 and macd_signal_4h >= 1 and macd_hist_4h >= 1 and obv_4h >= 9 and obv_slope_4h >= 3 and adx_4h >= 96 and stochastic_k_4h >= 68 and stochastic_d_4h >= 69 and williams_r_4h <= -34)
            )

            # --- is_buy_momentum_13 ---
            is_buy_momentum_13 = (
                (rsi_1h >= 59 and macd_1h >= 4 and macd_signal_1h >= 2 and macd_hist_1h >= 1 and obv_1h >= 8 and obv_slope_1h <= -1 and adx_1h >= 76 and stochastic_k_1h >= 41 and stochastic_d_1h >= 46 and williams_r_1h <= -67) and 
                (rsi_2h >= 67 and macd_2h >= 2 and macd_signal_2h >= 4 and macd_hist_2h >= 1 and obv_2h >= 4 and obv_slope_2h <= -2 and adx_2h >= 82 and stochastic_k_2h >= 44 and stochastic_d_2h >= 50 and williams_r_2h <= -61) and 
                (rsi_4h >= 74 and macd_4h >= 9 and macd_signal_4h <= -1 and macd_hist_4h >= 1 and obv_4h >= 1 and obv_slope_4h >= 2 and adx_4h >= 77 and stochastic_k_4h >= 38 and stochastic_d_4h >= 28 and williams_r_4h <= -49)
            )

            # --- is_buy_momentum_14 ---
            is_buy_momentum_14 = (
                (rsi_1h >= 68 and macd_1h >= 2 and macd_signal_1h >= 2 and macd_hist_1h >= 1 and obv_1h <= -1 and obv_slope_1h >= 1 and adx_1h >= 69 and stochastic_k_1h >= 73 and stochastic_d_1h >= 74 and williams_r_1h <= -25) and 
                (rsi_2h >= 73 and macd_2h >= 2 and macd_signal_2h >= 1 and macd_hist_2h >= 1 and obv_2h <= -1 and obv_slope_2h >= 3 and adx_2h >= 60 and stochastic_k_2h >= 82 and stochastic_d_2h >= 86 and williams_r_2h <= -17) and 
                (rsi_4h >= 64 and macd_4h >= 4 and macd_signal_4h <= -9 and macd_hist_4h >= 1 and obv_4h >= 3 and obv_slope_4h <= -3 and adx_4h >= 52 and stochastic_k_4h >= 83 and stochastic_d_4h >= 82 and williams_r_4h <= -20)
            )

            # --- is_buy_momentum_15 ---
            is_buy_momentum_15 = (
                (rsi_1h >= 61 and macd_1h >= 8 and macd_signal_1h >= 5 and macd_hist_1h >= 2 and obv_1h >= 4 and obv_slope_1h <= -1 and adx_1h >= 92 and stochastic_k_1h >= 51 and stochastic_d_1h >= 61 and williams_r_1h <= -58) and 
                (rsi_2h >= 69 and macd_2h >= 5 and macd_signal_2h >= 2 and macd_hist_2h >= 3 and obv_2h >= 1 and obv_slope_2h <= -2 and adx_2h >= 85 and stochastic_k_2h >= 58 and stochastic_d_2h >= 70 and williams_r_2h <= -54) and 
                (rsi_4h >= 71 and macd_4h >= 3 and macd_signal_4h >= 1 and macd_hist_4h >= 2 and obv_4h <= -2 and obv_slope_4h <= -7 and adx_4h >= 82 and stochastic_k_4h >= 69 and stochastic_d_4h >= 69 and williams_r_4h <= -54)
            )

            # --- is_buy_momentum_16 ---
            is_buy_momentum_16 = (
                (rsi_1h >= 48 and macd_1h >= 1 and macd_signal_1h >= 1 and macd_hist_1h <= -1 and obv_1h >= 2 and obv_slope_1h >= 0 and adx_1h >= 50 and stochastic_k_1h >= 19 and stochastic_d_1h >= 30 and williams_r_1h <= -85) and 
                (rsi_2h >= 52 and macd_2h >= 1 and macd_signal_2h >= 7 and macd_hist_2h >= 6 and obv_2h >= 1 and obv_slope_2h <= -2 and adx_2h >= 60 and stochastic_k_2h >= 37 and stochastic_d_2h >= 58 and williams_r_2h <= -80) and 
                (rsi_4h >= 52 and macd_4h >= 5 and macd_signal_4h <= -7 and macd_hist_4h >= 6 and obv_4h >= 7 and obv_slope_4h <= -3 and adx_4h >= 64 and stochastic_k_4h >= 48 and stochastic_d_4h >= 64 and williams_r_4h <= -80)
            )

            # --- is_buy_momentum_17 ---
            is_buy_momentum_17 = (
                (rsi_1h >= 78 and macd_1h >= 6 and macd_signal_1h >= 5 and macd_hist_1h >= 8 and obv_1h >= 1 and obv_slope_1h >= 1 and adx_1h >= 93 and stochastic_k_1h >= 75 and stochastic_d_1h >= 74 and williams_r_1h <= -9) and 
                (rsi_2h >= 85 and macd_2h >= 7 and macd_signal_2h >= 5 and macd_hist_2h >= 2 and obv_2h >= 8 and obv_slope_2h >= 2 and adx_2h >= 84 and stochastic_k_2h >= 93 and stochastic_d_2h >= 93 and williams_r_2h <= -3) and 
                (rsi_4h >= 81 and macd_4h >= 6 and macd_signal_4h >= 2 and macd_hist_4h >= 3 and obv_4h >= 1 and obv_slope_4h >= 3 and adx_4h >= 71 and stochastic_k_4h >= 92 and stochastic_d_4h >= 88 and williams_r_4h <= -3)
            )

            # --- is_buy_momentum_18 ---
            is_buy_momentum_18 = (
                (rsi_1h >= 77 and macd_1h >= 4 and macd_signal_1h >= 3 and macd_hist_1h >= 1 and obv_1h >= 1 and obv_slope_1h >= 6 and adx_1h >= 51 and stochastic_k_1h >= 94 and stochastic_d_1h >= 90 and williams_r_1h <= -2) and 
                (rsi_2h >= 76 and macd_2h >= 5 and macd_signal_2h >= 4 and macd_hist_2h >= 1 and obv_2h >= 5 and obv_slope_2h >= 1 and adx_2h >= 84 and stochastic_k_2h >= 96 and stochastic_d_2h >= 86 and williams_r_2h <= -1) and 
                (rsi_4h >= 73 and macd_4h >= 6 and macd_signal_4h >= 4 and macd_hist_4h >= 2 and obv_4h >= 3 and obv_slope_4h >= 1 and adx_4h >= 87 and stochastic_k_4h >= 90 and stochastic_d_4h >= 86 and williams_r_4h <= -1)
            )

            # --- is_buy_momentum_19 ---
            is_buy_momentum_19 = (
                (rsi_1h >= 61 and macd_1h >= 2 and macd_signal_1h >= 2 and macd_hist_1h <= -1 and obv_1h >= 2 and obv_slope_1h >= 3 and adx_1h >= 39 and stochastic_k_1h >= 42 and stochastic_d_1h >= 41 and williams_r_1h <= -43) and 
                (rsi_2h >= 68 and macd_2h >= 3 and macd_signal_2h >= 2 and macd_hist_2h >= 9 and obv_2h >= 6 and obv_slope_2h >= 5 and adx_2h >= 68 and stochastic_k_2h >= 58 and stochastic_d_2h >= 67 and williams_r_2h <= -32) and 
                (rsi_4h >= 72 and macd_4h >= 2 and macd_signal_4h >= 1 and macd_hist_4h >= 1 and obv_4h >= 1 and obv_slope_4h >= 1 and adx_4h >= 84 and stochastic_k_4h >= 72 and stochastic_d_4h >= 80 and williams_r_4h <= -30)
            )

            # --- is_buy_momentum_20 ---
            is_buy_momentum_20 = (
                (rsi_1h >= 55 and macd_1h >= 5 and macd_signal_1h >= 7 and macd_hist_1h <= -2 and obv_1h >= 6 and obv_slope_1h <= -4 and adx_1h >= 18 and stochastic_k_1h >= 20 and stochastic_d_1h >= 21 and williams_r_1h <= -77) and 
                (rsi_2h >= 60 and macd_2h >= 1 and macd_signal_2h >= 9 and macd_hist_2h >= 6 and obv_2h >= 1 and obv_slope_2h <= -4 and adx_2h >= 50 and stochastic_k_2h >= 42 and stochastic_d_2h >= 41 and williams_r_2h <= -54) and 
                (rsi_4h >= 62 and macd_4h >= 9 and macd_signal_4h >= 5 and macd_hist_4h >= 4 and obv_4h <= -8 and obv_slope_4h >= 2 and adx_4h >= 70 and stochastic_k_4h >= 45 and stochastic_d_4h >= 53 and williams_r_4h <= -54)
            )

            # --- is_buy_momentum_21 ---
            is_buy_momentum_21 = (
                (rsi_1h >= 52 and macd_1h >= 3 and macd_signal_1h >= 4 and macd_hist_1h <= -9 and obv_1h <= -2 and obv_slope_1h <= -1 and adx_1h >= 6 and stochastic_k_1h >= 25 and stochastic_d_1h >= 27 and williams_r_1h <= -75) and 
                (rsi_2h >= 56 and macd_2h >= 5 and macd_signal_2h >= 4 and macd_hist_2h >= 5 and obv_2h <= -1 and obv_slope_2h <= -2 and adx_2h >= 61 and stochastic_k_2h >= 47 and stochastic_d_2h >= 48 and williams_r_2h <= -57) and 
                (rsi_4h >= 57 and macd_4h >= 4 and macd_signal_4h >= 1 and macd_hist_4h >= 2 and obv_4h <= -1 and obv_slope_4h <= -9 and adx_4h >= 61 and stochastic_k_4h >= 49 and stochastic_d_4h >= 57 and williams_r_4h <= -55)
            )

            # --- is_buy_momentum_22 ---
            is_buy_momentum_22 = (
                (rsi_1h >= 58 and macd_1h >= 1 and macd_signal_1h <= -2 and macd_hist_1h >= 4 and obv_1h <= -9 and obv_slope_1h >= 5 and adx_1h >= 32 and stochastic_k_1h >= 81 and stochastic_d_1h >= 84 and williams_r_1h <= -6) and 
                (rsi_2h >= 19 and macd_2h <= -3 and macd_signal_2h <= -1 and macd_hist_2h <= -1 and obv_2h <= -1 and obv_slope_2h <= -1 and adx_2h >= 75 and stochastic_k_2h >= 48 and stochastic_d_2h >= 57 and williams_r_2h <= -80) and 
                (rsi_4h >= 23 and macd_4h <= -4 and macd_signal_4h <= -3 and macd_hist_4h <= -1 and obv_4h <= -3 and obv_slope_4h <= -1 and adx_4h >= 72 and stochastic_k_4h >= 51 and stochastic_d_4h >= 48 and williams_r_4h <= -61)
            )

            # --- is_buy_momentum_23 ---
            is_buy_momentum_23 = (
                (rsi_1h >= 43 and macd_1h <= -2 and macd_signal_1h <= -5 and macd_hist_1h >= 3 and obv_1h <= -2 and obv_slope_1h <= -1 and adx_1h >= 57 and stochastic_k_1h >= 38 and stochastic_d_1h >= 54 and williams_r_1h <= -76) and 
                (rsi_2h >= 30 and macd_2h <= -2 and macd_signal_2h <= -2 and macd_hist_2h >= 2 and obv_2h <= -1 and obv_slope_2h <= -1 and adx_2h >= 27 and stochastic_k_2h >= 45 and stochastic_d_2h >= 63 and williams_r_2h <= -98) and 
                (rsi_4h >= 33 and macd_4h <= -3 and macd_signal_4h <= -2 and macd_hist_4h <= -7 and obv_4h <= -1 and obv_slope_4h <= -2 and adx_4h >= 57 and stochastic_k_4h >= 34 and stochastic_d_4h >= 36 and williams_r_4h <= -82)
            )

            # --- is_buy_momentum_24 ---
            is_buy_momentum_24 = (
                (rsi_1h >= 77 and macd_1h >= 5 and macd_signal_1h >= 2 and macd_hist_1h >= 2 and obv_1h <= -9 and obv_slope_1h >= 1 and adx_1h >= 83 and stochastic_k_1h >= 61 and stochastic_d_1h >= 51 and williams_r_1h <= -5)
            )

            # --- is_buy_momentum_25 ---
            is_buy_momentum_25 = (
                (rsi_1h >= 78 and macd_1h >= 3 and macd_signal_1h >= 2 and macd_hist_1h >= 7 and obv_1h >= 2 and obv_slope_1h >= 9 and adx_1h >= 68 and stochastic_k_1h >= 92 and stochastic_d_1h >= 90 and williams_r_1h <= -4) and 
                (rsi_2h >= 75 and macd_2h >= 3 and macd_signal_2h >= 2 and macd_hist_2h >= 1 and obv_2h >= 4 and obv_slope_2h >= 2 and adx_2h >= 80 and stochastic_k_2h >= 92 and stochastic_d_2h >= 88 and williams_r_2h <= -3) and 
                (rsi_4h >= 74 and macd_4h >= 3 and macd_signal_4h >= 1 and macd_hist_4h >= 2 and obv_4h <= -3 and obv_slope_4h >= 4 and adx_4h >= 53 and stochastic_k_4h >= 92 and stochastic_d_4h >= 91 and williams_r_4h <= -2)
            )

            # --- is_buy_momentum_26 ---
            is_buy_momentum_26 = (
                (rsi_1h >= 65 and macd_1h >= 2 and macd_signal_1h >= 2 and macd_hist_1h >= 4 and obv_1h >= 2 and obv_slope_1h >= 1 and adx_1h >= 57 and stochastic_k_1h >= 64 and stochastic_d_1h >= 70 and williams_r_1h <= -34) and 
                (rsi_2h >= 71 and macd_2h >= 2 and macd_signal_2h >= 1 and macd_hist_2h >= 1 and obv_2h >= 1 and obv_slope_2h <= -2 and adx_2h >= 73 and stochastic_k_2h >= 80 and stochastic_d_2h >= 85 and williams_r_2h <= -28) and 
                (rsi_4h >= 84 and macd_4h >= 2 and macd_signal_4h >= 1 and macd_hist_4h >= 1 and obv_4h >= 3 and obv_slope_4h >= 4 and adx_4h >= 63 and stochastic_k_4h >= 81 and stochastic_d_4h >= 81 and williams_r_4h <= -20)
            )

            # --- is_buy_momentum_27 ---
            is_buy_momentum_27 = (
                (rsi_1h >= 57 and macd_1h >= 1 and macd_signal_1h >= 1 and macd_hist_1h <= -9 and obv_1h >= 6 and obv_slope_1h <= -2 and adx_1h >= 4 and stochastic_k_1h >= 55 and stochastic_d_1h >= 68 and williams_r_1h <= -57) and 
                (rsi_2h >= 63 and macd_2h >= 1 and macd_signal_2h >= 1 and macd_hist_2h >= 3 and obv_2h >= 3 and obv_slope_2h <= -4 and adx_2h >= 56 and stochastic_k_2h >= 78 and stochastic_d_2h >= 79 and williams_r_2h <= -31) and 
                (rsi_4h >= 69 and macd_4h >= 1 and macd_signal_4h >= 1 and macd_hist_4h >= 6 and obv_4h >= 6 and obv_slope_4h <= -1 and adx_4h >= 66 and stochastic_k_4h >= 82 and stochastic_d_4h >= 84 and williams_r_4h <= -31)
            )

            # --- is_buy_momentum_28 ---
            is_buy_momentum_28 = (
                (rsi_1h >= 94 and macd_1h >= 2 and macd_signal_1h >= 6 and macd_hist_1h >= 1 and obv_1h >= 4 and obv_slope_1h >= 5 and adx_1h >= 87 and stochastic_k_1h >= 91 and stochastic_d_1h >= 82 and williams_r_1h <= -9) and 
                (rsi_2h >= 90 and macd_2h >= 2 and macd_signal_2h >= 4 and macd_hist_2h >= 1 and obv_2h >= 7 and obv_slope_2h >= 7 and adx_2h >= 91 and stochastic_k_2h >= 76 and stochastic_d_2h >= 66 and williams_r_2h <= -20) and 
                (rsi_4h >= 85 and macd_4h >= 1 and macd_signal_4h <= -1 and macd_hist_4h >= 1 and obv_4h <= -5 and obv_slope_4h >= 8 and adx_4h >= 88 and stochastic_k_4h >= 68 and stochastic_d_4h >= 59 and williams_r_4h <= -20)
            )

            # --- is_buy_momentum_29 ---
            is_buy_momentum_29 = (
                (rsi_1h >= 56 and macd_1h >= 2 and macd_signal_1h >= 2 and macd_hist_1h <= -7 and obv_1h >= 1 and obv_slope_1h >= 2 and adx_1h >= 16 and stochastic_k_1h >= 35 and stochastic_d_1h >= 35 and williams_r_1h <= -56) and 
                (rsi_2h >= 65 and macd_2h >= 4 and macd_signal_2h >= 4 and macd_hist_2h >= 1 and obv_2h >= 3 and obv_slope_2h >= 3 and adx_2h >= 51 and stochastic_k_2h >= 62 and stochastic_d_2h >= 64 and williams_r_2h <= -36) and 
                (rsi_4h >= 67 and macd_4h >= 4 and macd_signal_4h >= 2 and macd_hist_4h >= 1 and obv_4h >= 2 and obv_slope_4h >= 8 and adx_4h >= 73 and stochastic_k_4h >= 68 and stochastic_d_4h >= 68 and williams_r_4h <= -33)
            )

            # --- is_buy_momentum_30 ---
            is_buy_momentum_30 = (
                (rsi_1h >= 73 and macd_1h >= 1 and macd_signal_1h >= 9 and macd_hist_1h >= 1 and obv_1h >= 1 and obv_slope_1h >= 2 and adx_1h >= 79 and stochastic_k_1h >= 66 and stochastic_d_1h >= 58 and williams_r_1h <= -21) and 
                (rsi_2h >= 75 and macd_2h >= 9 and macd_signal_2h >= 4 and macd_hist_2h >= 5 and obv_2h >= 6 and obv_slope_2h >= 4 and adx_2h >= 86 and stochastic_k_2h >= 66 and stochastic_d_2h >= 58 and williams_r_2h <= -15) and 
                (rsi_4h >= 67 and macd_4h >= 5 and macd_signal_4h <= -5 and macd_hist_4h >= 5 and obv_4h >= 6 and obv_slope_4h >= 8 and adx_4h >= 86 and stochastic_k_4h >= 63 and stochastic_d_4h >= 56 and williams_r_4h <= -14)
            )

            # --- is_buy_momentum_31 ---
            is_buy_momentum_31 = (
                (rsi_1h >= 52 and macd_1h >= 1 and macd_signal_1h >= 2 and macd_hist_1h <= -1 and obv_1h >= 3 and obv_slope_1h >= 2 and adx_1h >= 37 and stochastic_k_1h >= 28 and stochastic_d_1h >= 24 and williams_r_1h <= -64) and 
                (rsi_2h >= 59 and macd_2h >= 6 and macd_signal_2h >= 7 and macd_hist_2h <= -1 and obv_2h >= 6 and obv_slope_2h >= 3 and adx_2h >= 34 and stochastic_k_2h >= 42 and stochastic_d_2h >= 44 and williams_r_2h <= -48) and 
                (rsi_4h >= 67 and macd_4h >= 9 and macd_signal_4h >= 7 and macd_hist_4h >= 1 and obv_4h >= 6 and obv_slope_4h >= 5 and adx_4h >= 58 and stochastic_k_4h >= 65 and stochastic_d_4h >= 73 and williams_r_4h <= -29)
            )

            # --- is_buy_momentum_32 ---
            is_buy_momentum_32 = (
                (rsi_1h >= 90 and macd_1h >= 3 and macd_signal_1h >= 8 and macd_hist_1h >= 2 and obv_1h >= 8 and obv_slope_1h >= 4 and adx_1h >= 94 and stochastic_k_1h >= 90 and stochastic_d_1h >= 91 and williams_r_1h <= -14) and 
                (rsi_2h >= 90 and macd_2h >= 3 and macd_signal_2h <= -2 and macd_hist_2h >= 3 and obv_2h >= 7 and obv_slope_2h >= 1 and adx_2h >= 92 and stochastic_k_2h >= 90 and stochastic_d_2h >= 78 and williams_r_2h <= -16) and 
                (rsi_4h >= 85 and macd_4h >= 2 and macd_signal_4h <= -7 and macd_hist_4h >= 3 and obv_4h >= 2 and obv_slope_4h >= 1 and adx_4h >= 71 and stochastic_k_4h >= 64 and stochastic_d_4h >= 42 and williams_r_4h <= -16)
            )

            # --- is_buy_momentum_33 ---
            is_buy_momentum_33 = (
                (rsi_1h >= 59 and macd_1h >= 5 and macd_signal_1h >= 4 and macd_hist_1h >= 3 and obv_1h <= -7 and obv_slope_1h <= -1 and adx_1h >= 31 and stochastic_k_1h >= 47 and stochastic_d_1h >= 65 and williams_r_1h <= -65) and 
                (rsi_2h >= 69 and macd_2h >= 5 and macd_signal_2h >= 3 and macd_hist_2h >= 2 and obv_2h >= 5 and obv_slope_2h >= 4 and adx_2h >= 61 and stochastic_k_2h >= 82 and stochastic_d_2h >= 77 and williams_r_2h <= -16) and 
                (rsi_4h >= 71 and macd_4h >= 5 and macd_signal_4h >= 2 and macd_hist_4h >= 2 and obv_4h >= 4 and obv_slope_4h >= 4 and adx_4h >= 56 and stochastic_k_4h >= 70 and stochastic_d_4h >= 72 and williams_r_4h <= -16)
            )

            # --- is_buy_momentum_34 ---
            is_buy_momentum_34 = (
                (rsi_1h >= 57 and macd_1h >= 7 and macd_signal_1h >= 6 and macd_hist_1h >= 5 and obv_1h >= 4 and obv_slope_1h <= -1 and adx_1h >= 87 and stochastic_k_1h >= 72 and stochastic_d_1h >= 76 and williams_r_1h <= -40) and 
                (rsi_2h >= 64 and macd_2h >= 9 and macd_signal_2h >= 7 and macd_hist_2h >= 1 and obv_2h <= -5 and obv_slope_2h <= -3 and adx_2h >= 92 and stochastic_k_2h >= 80 and stochastic_d_2h >= 79 and williams_r_2h <= -30) and 
                (rsi_4h >= 74 and macd_4h >= 1 and macd_signal_4h >= 8 and macd_hist_4h >= 3 and obv_4h >= 1 and obv_slope_4h >= 6 and adx_4h >= 91 and stochastic_k_4h >= 83 and stochastic_d_4h >= 78 and williams_r_4h <= -12)
            )

            # --- is_buy_momentum_35 ---
            is_buy_momentum_35 = (
                (rsi_1h >= 19 and macd_1h <= -4 and macd_signal_1h <= -3 and macd_hist_1h <= -1 and obv_1h <= -2 and obv_slope_1h <= -5 and adx_1h >= 42 and stochastic_k_1h >= 11 and stochastic_d_1h >= 14 and williams_r_1h <= -94) and 
                (rsi_2h >= 25 and macd_2h <= -4 and macd_signal_2h <= -3 and macd_hist_2h <= -1 and obv_2h >= 1 and obv_slope_2h <= -1 and adx_2h >= 67 and stochastic_k_2h >= 6 and stochastic_d_2h >= 6 and williams_r_2h <= -96) and 
                (rsi_4h >= 40 and macd_4h <= -5 and macd_signal_4h <= -3 and macd_hist_4h <= -1 and obv_4h >= 1 and obv_slope_4h >= 1 and adx_4h >= 9 and stochastic_k_4h >= 13 and stochastic_d_4h >= 7 and williams_r_4h <= -69)
            )

            # --- is_buy_momentum_36 ---
            is_buy_momentum_36 = (
                (rsi_1h >= 78 and macd_1h >= 2 and macd_signal_1h >= 1 and macd_hist_1h >= 1 and obv_1h >= 2 and obv_slope_1h >= 3 and adx_1h >= 82 and stochastic_k_1h >= 69 and stochastic_d_1h >= 55 and williams_r_1h <= -2) and 
                (rsi_2h >= 42 and macd_2h >= 1 and macd_signal_2h >= 1 and macd_hist_2h <= -2 and obv_2h >= 6 and obv_slope_2h <= -1 and adx_2h >= 92 and stochastic_k_2h >= 37 and stochastic_d_2h >= 43 and williams_r_2h <= -92) and 
                (rsi_4h >= 43 and macd_4h >= 1 and macd_signal_4h >= 2 and macd_hist_4h <= -6 and obv_4h >= 3 and obv_slope_4h <= -2 and adx_4h >= 56 and stochastic_k_4h >= 35 and stochastic_d_4h >= 43 and williams_r_4h <= -94)
            )

            # --- is_buy_momentum_37 ---
            is_buy_momentum_37 = (
                (rsi_1h >= 60 and macd_1h >= 1 and macd_signal_1h >= 3 and macd_hist_1h >= 1 and obv_1h >= 1 and obv_slope_1h >= 4 and adx_1h >= 50 and stochastic_k_1h >= 32 and stochastic_d_1h >= 23 and williams_r_1h <= -52) and 
                (rsi_2h >= 56 and macd_2h <= -1 and macd_signal_2h <= -3 and macd_hist_2h >= 1 and obv_2h <= -3 and obv_slope_2h >= 1 and adx_2h >= 56 and stochastic_k_2h >= 24 and stochastic_d_2h >= 22 and williams_r_2h <= -52) and 
                (rsi_4h >= 68 and macd_4h <= -6 and macd_signal_4h <= -1 and macd_hist_4h >= 1 and obv_4h >= 1 and obv_slope_4h >= 2 and adx_4h >= 69 and stochastic_k_4h >= 42 and stochastic_d_4h >= 25 and williams_r_4h <= -11)
            )

            # --- is_buy_momentum_38 ---
            is_buy_momentum_38 = (
                (rsi_1h >= 74 and macd_1h >= 2 and macd_signal_1h >= 6 and macd_hist_1h >= 1 and obv_1h <= -2 and obv_slope_1h >= 1 and adx_1h >= 66 and stochastic_k_1h >= 83 and stochastic_d_1h >= 85 and williams_r_1h <= -1) and 
                (rsi_2h >= 77 and macd_2h >= 1 and macd_signal_2h <= -2 and macd_hist_2h >= 4 and obv_2h >= 6 and obv_slope_2h >= 7 and adx_2h >= 71 and stochastic_k_2h >= 92 and stochastic_d_2h >= 87 and williams_r_2h <= -2) and 
                (rsi_4h >= 68 and macd_4h <= -3 and macd_signal_4h <= -7 and macd_hist_4h >= 4 and obv_4h >= 1 and obv_slope_4h >= 1 and adx_4h >= 56 and stochastic_k_4h >= 50 and stochastic_d_4h >= 36 and williams_r_4h <= -27)
            )
            ...
            # --- is_sell_momentum_1 ---
            is_sell_momentum_1 = (
                (rsi_1h >= 19 and macd_1h <= -3 and macd_signal_1h <= -3 and macd_hist_1h <= -1 and obv_1h <= -6 and obv_slope_1h <= -1 and adx_1h >= 74 and stochastic_k_1h >= 8 and stochastic_d_1h >= 9 and williams_r_1h <= -98) and 
                (rsi_2h >= 19 and macd_2h <= -3 and macd_signal_2h <= -2 and macd_hist_2h <= -1 and obv_2h <= -1 and obv_slope_2h <= -3 and adx_2h >= 79 and stochastic_k_2h >= 4 and stochastic_d_2h >= 3 and williams_r_2h <= -99) and 
                (rsi_4h >= 29 and macd_4h <= -2 and macd_signal_4h <= -6 and macd_hist_4h <= -2 and obv_4h <= -2 and obv_slope_4h <= -3 and adx_4h >= 16 and stochastic_k_4h >= 1 and stochastic_d_4h >= 2 and williams_r_4h <= -99)
            )

            # --- is_sell_momentum_2 ---
            is_sell_momentum_2 = (
                (rsi_1h >= 44 and macd_1h <= -1 and macd_signal_1h <= -1 and macd_hist_1h >= 1 and obv_1h <= -4 and obv_slope_1h >= 7 and adx_1h >= 12 and stochastic_k_1h >= 25 and stochastic_d_1h >= 22 and williams_r_1h <= -51) and 
                (rsi_2h >= 41 and macd_2h <= -3 and macd_signal_2h <= -3 and macd_hist_2h >= 3 and obv_2h >= 2 and obv_slope_2h >= 1 and adx_2h >= 71 and stochastic_k_2h >= 5 and stochastic_d_2h >= 5 and williams_r_2h <= -90) and 
                (rsi_4h >= 40 and macd_4h <= -4 and macd_signal_4h <= -3 and macd_hist_4h <= -6 and obv_4h >= 3 and obv_slope_4h >= 1 and adx_4h >= 20 and stochastic_k_4h >= 8 and stochastic_d_4h >= 9 and williams_r_4h <= -89)
            )

            # --- is_sell_momentum_3 ---
            is_sell_momentum_3 = (
                (rsi_1h >= 27 and macd_1h <= -1 and macd_signal_1h <= -9 and macd_hist_1h <= -7 and obv_1h >= 8 and obv_slope_1h <= -2 and adx_1h >= 66 and stochastic_k_1h >= 2 and stochastic_d_1h >= 3 and williams_r_1h <= -98) and 
                (rsi_2h >= 37 and macd_2h <= -6 and macd_signal_2h >= 3 and macd_hist_2h <= -1 and obv_2h >= 1 and obv_slope_2h <= -3 and adx_2h >= 16 and stochastic_k_2h >= 4 and stochastic_d_2h >= 15 and williams_r_2h <= -99) and 
                (rsi_4h >= 45 and macd_4h >= 1 and macd_signal_4h >= 2 and macd_hist_4h <= -1 and obv_4h >= 4 and obv_slope_4h <= -8 and adx_4h >= 30 and stochastic_k_4h >= 22 and stochastic_d_4h >= 30 and williams_r_4h <= -86)
            )

            # --- is_sell_momentum_4 ---
            is_sell_momentum_4 = (
                (rsi_1h >= 44 and macd_1h <= -1 and macd_signal_1h <= -1 and macd_hist_1h <= -3 and obv_1h >= 9 and obv_slope_1h >= 3 and adx_1h >= 6 and stochastic_k_1h >= 36 and stochastic_d_1h >= 25 and williams_r_1h <= -61) and 
                (rsi_2h >= 46 and macd_2h <= -4 and macd_signal_2h >= 1 and macd_hist_2h <= -1 and obv_2h >= 1 and obv_slope_2h >= 9 and adx_2h >= 18 and stochastic_k_2h >= 3 and stochastic_d_2h >= 3 and williams_r_2h <= -96)
            )

            # --- is_sell_momentum_5 ---
            is_sell_momentum_5 = (
                (rsi_1h >= 42 and macd_1h <= -2 and macd_signal_1h <= -2 and macd_hist_1h <= -5 and obv_1h <= -4 and obv_slope_1h <= -2 and adx_1h >= 10 and stochastic_k_1h >= 17 and stochastic_d_1h >= 14 and williams_r_1h <= -87) and 
                (rsi_2h >= 45 and macd_2h <= -9 and macd_signal_2h >= 9 and macd_hist_2h <= -1 and obv_2h >= 9 and obv_slope_2h <= -6 and adx_2h >= 58 and stochastic_k_2h >= 2 and stochastic_d_2h >= 2 and williams_r_2h <= -98) and 
                (rsi_4h >= 47 and macd_4h >= 1 and macd_signal_4h >= 2 and macd_hist_4h <= -1 and obv_4h <= -3 and obv_slope_4h <= -1 and adx_4h >= 76 and stochastic_k_4h >= 6 and stochastic_d_4h >= 6 and williams_r_4h <= -93)
            )

            # --- is_sell_momentum_6 ---
            is_sell_momentum_6 = (
                (rsi_1h >= 29 and macd_1h <= -1 and macd_signal_1h <= -1 and macd_hist_1h <= -5 and obv_1h >= 8 and obv_slope_1h <= -1 and adx_1h >= 39 and stochastic_k_1h >= 6 and stochastic_d_1h >= 5 and williams_r_1h <= -93) and 
                (rsi_2h >= 34 and macd_2h <= -9 and macd_signal_2h <= -4 and macd_hist_2h <= -5 and obv_2h >= 6 and obv_slope_2h >= 2 and adx_2h >= 57 and stochastic_k_2h >= 2 and stochastic_d_2h >= 3 and williams_r_2h <= -96) and 
                (rsi_4h >= 39 and macd_4h <= -3 and macd_signal_4h >= 1 and macd_hist_4h <= -5 and obv_4h >= 1 and obv_slope_4h >= 4 and adx_4h >= 12 and stochastic_k_4h >= 5 and stochastic_d_4h >= 6 and williams_r_4h <= -96)
            )

            # --- is_sell_momentum_7 ---
            is_sell_momentum_7 = (
                (rsi_1h >= 32 and macd_1h <= -3 and macd_signal_1h <= -2 and macd_hist_1h <= -3 and obv_1h <= -2 and obv_slope_1h >= 0 and adx_1h >= 100 and stochastic_k_1h >= 13 and stochastic_d_1h >= 9 and williams_r_1h <= -83) and 
                (rsi_2h >= 27 and macd_2h <= -4 and macd_signal_2h <= -3 and macd_hist_2h <= -9 and obv_2h <= -6 and obv_slope_2h >= 2 and adx_2h >= 37 and stochastic_k_2h >= 5 and stochastic_d_2h >= 7 and williams_r_2h <= -88) and 
                (rsi_4h >= 21 and macd_4h <= -5 and macd_signal_4h <= -4 and macd_hist_4h <= -1 and obv_4h <= -8 and obv_slope_4h >= 0 and adx_4h >= 5 and stochastic_k_4h >= 9 and stochastic_d_4h >= 7 and williams_r_4h <= -86)
            )

            # --- is_sell_momentum_8 ---
            is_sell_momentum_8 = (
                (rsi_1h >= 24 and macd_1h <= -5 and macd_signal_1h <= -4 and macd_hist_1h <= -1 and obv_1h >= 2 and obv_slope_1h <= -1 and adx_1h >= 50 and stochastic_k_1h >= 11 and stochastic_d_1h >= 9 and williams_r_1h <= -84) and 
                (rsi_2h >= 24 and macd_2h <= -5 and macd_signal_2h <= -3 and macd_hist_2h <= -2 and obv_2h <= -3 and obv_slope_2h >= 4 and adx_2h >= 20 and stochastic_k_2h >= 8 and stochastic_d_2h >= 8 and williams_r_2h <= -87) and 
                (rsi_4h >= 25 and macd_4h <= -5 and macd_signal_4h <= -3 and macd_hist_4h <= -2 and obv_4h >= 4 and obv_slope_4h >= 7 and adx_4h >= 13 and stochastic_k_4h >= 7 and stochastic_d_4h >= 7 and williams_r_4h <= -90)
            )

            # --- is_sell_momentum_9 ---
            is_sell_momentum_9 = (
                (rsi_1h >= 20 and macd_1h <= -4 and macd_signal_1h <= -3 and macd_hist_1h <= -1 and obv_1h <= -1 and obv_slope_1h >= 4 and adx_1h >= 90 and stochastic_k_1h >= 11 and stochastic_d_1h >= 7 and williams_r_1h <= -85) and 
                (rsi_2h >= 14 and macd_2h <= -4 and macd_signal_2h <= -2 and macd_hist_2h <= -1 and obv_2h >= 1 and obv_slope_2h <= -2 and adx_2h >= 73 and stochastic_k_2h >= 7 and stochastic_d_2h >= 7 and williams_r_2h <= -86) and 
                (rsi_4h >= 22 and macd_4h <= -4 and macd_signal_4h <= -1 and macd_hist_4h <= -2 and obv_4h >= 5 and obv_slope_4h <= -3 and adx_4h >= 64 and stochastic_k_4h >= 5 and stochastic_d_4h >= 6 and williams_r_4h <= -97)
            )

            # --- is_sell_momentum_10 ---
            is_sell_momentum_10 = (
                (rsi_1h >= 33 and macd_1h <= -4 and macd_signal_1h <= -3 and macd_hist_1h <= -6 and obv_1h >= 1 and obv_slope_1h <= -7 and adx_1h >= 6 and stochastic_k_1h >= 3 and stochastic_d_1h >= 5 and williams_r_1h <= -93) and 
                (rsi_2h >= 26 and macd_2h <= -6 and macd_signal_2h <= -6 and macd_hist_2h <= -7 and obv_2h >= 2 and obv_slope_2h <= -1 and adx_2h >= 22 and stochastic_k_2h >= 6 and stochastic_d_2h >= 12 and williams_r_2h <= -93) and 
                (rsi_4h >= 19 and macd_4h <= -1 and macd_signal_4h <= -9 and macd_hist_4h <= -2 and obv_4h <= -5 and obv_slope_4h <= -4 and adx_4h >= 49 and stochastic_k_4h >= 7 and stochastic_d_4h >= 8 and williams_r_4h <= -99)
            )

            # --- is_sell_momentum_11 ---
            is_sell_momentum_11 = (
                (rsi_1h >= 27 and macd_1h <= -1 and macd_signal_1h <= -1 and macd_hist_1h <= -2 and obv_1h <= -7 and obv_slope_1h >= 3 and adx_1h >= 6 and stochastic_k_1h >= 9 and stochastic_d_1h >= 13 and williams_r_1h <= -92) and 
                (rsi_2h >= 20 and macd_2h <= -1 and macd_signal_2h <= -1 and macd_hist_2h <= -2 and obv_2h <= -9 and obv_slope_2h <= -6 and adx_2h >= 28 and stochastic_k_2h >= 15 and stochastic_d_2h >= 22 and williams_r_2h <= -92) and 
                (rsi_4h >= 18 and macd_4h <= -3 and macd_signal_4h <= -2 and macd_hist_4h <= -2 and obv_4h <= -1 and obv_slope_4h <= -1 and adx_4h >= 36 and stochastic_k_4h >= 13 and stochastic_d_4h >= 13 and williams_r_4h <= -88)
            )

            # --- is_sell_momentum_12 ---
            is_sell_momentum_12 = (
                (rsi_1h >= 35 and macd_1h <= -1 and macd_signal_1h <= -3 and macd_hist_1h <= -1 and obv_1h <= -8 and obv_slope_1h <= -3 and adx_1h >= 27 and stochastic_k_1h >= 3 and stochastic_d_1h >= 5 and williams_r_1h <= -97) and 
                (rsi_2h >= 37 and macd_2h <= -2 and macd_signal_2h <= -2 and macd_hist_2h <= -1 and obv_2h <= -8 and obv_slope_2h <= -6 and adx_2h >= 37 and stochastic_k_2h >= 2 and stochastic_d_2h >= 12 and williams_r_2h <= -97) and 
                (rsi_4h >= 30 and macd_4h <= -8 and macd_signal_4h <= -9 and macd_hist_4h >= 8 and obv_4h <= -5 and obv_slope_4h <= -1 and adx_4h >= 11 and stochastic_k_4h >= 10 and stochastic_d_4h >= 11 and williams_r_4h <= -98)
            )

            # --- is_sell_momentum_13 ---
            is_sell_momentum_13 = (
                (rsi_1h >= 31 and macd_1h <= -3 and macd_signal_1h <= -2 and macd_hist_1h <= -4 and obv_1h <= -1 and obv_slope_1h <= -1 and adx_1h >= 55 and stochastic_k_1h >= 16 and stochastic_d_1h >= 13 and williams_r_1h <= -88) and 
                (rsi_2h >= 25 and macd_2h <= -4 and macd_signal_2h <= -3 and macd_hist_2h <= -7 and obv_2h <= -7 and obv_slope_2h <= -2 and adx_2h >= 52 and stochastic_k_2h >= 11 and stochastic_d_2h >= 8 and williams_r_2h <= -88) and 
                (rsi_4h >= 21 and macd_4h <= -6 and macd_signal_4h <= -4 and macd_hist_4h <= -1 and obv_4h <= -5 and obv_slope_4h <= -5 and adx_4h >= 61 and stochastic_k_4h >= 6 and stochastic_d_4h >= 9 and williams_r_4h <= -100)
            )

            # --- is_sell_momentum_14 ---
            is_sell_momentum_14 = (
                (rsi_1h >= 17 and macd_1h <= -2 and macd_signal_1h <= -2 and macd_hist_1h <= -7 and obv_1h <= -2 and obv_slope_1h <= -6 and adx_1h >= 100 and stochastic_k_1h >= 5 and stochastic_d_1h >= 7 and williams_r_1h <= -98) and 
                (rsi_2h >= 17 and macd_2h <= -2 and macd_signal_2h <= -1 and macd_hist_2h <= -9 and obv_2h <= -1 and obv_slope_2h <= -1 and adx_2h >= 75 and stochastic_k_2h >= 4 and stochastic_d_2h >= 5 and williams_r_2h <= -98) and 
                (rsi_4h >= 23 and macd_4h <= -4 and macd_signal_4h <= -3 and macd_hist_4h <= -5 and obv_4h <= -2 and obv_slope_4h >= 2 and adx_4h >= 57 and stochastic_k_4h >= 5 and stochastic_d_4h >= 4 and williams_r_4h <= -92)
            )

            # --- is_sell_momentum_15 ---
            is_sell_momentum_15 = (
                (rsi_1h >= 24 and macd_1h <= -2 and macd_signal_1h <= -2 and macd_hist_1h <= -3 and obv_1h >= 4 and obv_slope_1h <= -8 and adx_1h >= 66 and stochastic_k_1h >= 15 and stochastic_d_1h >= 15 and williams_r_1h <= -90) and 
                (rsi_2h >= 18 and macd_2h <= -3 and macd_signal_2h <= -3 and macd_hist_2h <= -6 and obv_2h <= -6 and obv_slope_2h <= -1 and adx_2h >= 100 and stochastic_k_2h >= 10 and stochastic_d_2h >= 12 and williams_r_2h <= -92) and 
                (rsi_4h >= 18 and macd_4h <= -5 and macd_signal_4h <= -4 and macd_hist_4h <= -8 and obv_4h <= -4 and obv_slope_4h <= -5 and adx_4h >= 90 and stochastic_k_4h >= 11 and stochastic_d_4h >= 9 and williams_r_4h <= -85)
            )

            # --- is_sell_momentum_16 ---
            is_sell_momentum_16 = (
                (rsi_1h >= 16 and macd_1h <= -4 and macd_signal_1h <= -3 and macd_hist_1h <= -1 and obv_1h >= 1 and obv_slope_1h <= -1 and adx_1h >= 80 and stochastic_k_1h >= 12 and stochastic_d_1h >= 11 and williams_r_1h <= -95) and 
                (rsi_2h >= 13 and macd_2h <= -6 and macd_signal_2h <= -5 and macd_hist_2h <= -1 and obv_2h <= -8 and obv_slope_2h <= -3 and adx_2h >= 93 and stochastic_k_2h >= 4 and stochastic_d_2h >= 8 and williams_r_2h <= -96) and 
                (rsi_4h >= 15 and macd_4h <= -9 and macd_signal_4h <= -7 and macd_hist_4h <= -1 and obv_4h <= -8 and obv_slope_4h <= -6 and adx_4h >= 85 and stochastic_k_4h >= 7 and stochastic_d_4h >= 7 and williams_r_4h <= -91)
            )

            # --- is_sell_momentum_17 ---
            is_sell_momentum_17 = (
                (rsi_1h >= 33 and macd_1h <= -8 and macd_signal_1h <= -8 and macd_hist_1h <= -2 and obv_1h <= -5 and obv_slope_1h <= -1 and adx_1h >= 2 and stochastic_k_1h >= 14 and stochastic_d_1h >= 20 and williams_r_1h <= -85) and 
                (rsi_2h >= 30 and macd_2h <= -1 and macd_signal_2h <= -1 and macd_hist_2h <= -3 and obv_2h <= -6 and obv_slope_2h <= -3 and adx_2h >= 4 and stochastic_k_2h >= 15 and stochastic_d_2h >= 17 and williams_r_2h <= -85) and 
                (rsi_4h >= 28 and macd_4h <= -2 and macd_signal_4h <= -2 and macd_hist_4h <= -6 and obv_4h <= -1 and obv_slope_4h <= -5 and adx_4h >= 34 and stochastic_k_4h >= 3 and stochastic_d_4h >= 4 and williams_r_4h <= -96)
            )

            # --- is_sell_momentum_18 ---
            is_sell_momentum_18 = (
                (rsi_1h >= 22 and macd_1h <= -7 and macd_signal_1h <= -6 and macd_hist_1h <= -1 and obv_1h <= -4 and obv_slope_1h >= 1 and adx_1h >= 79 and stochastic_k_1h >= 7 and stochastic_d_1h >= 5 and williams_r_1h <= -85) and 
                (rsi_2h >= 18 and macd_2h <= -1 and macd_signal_2h <= -9 and macd_hist_2h <= -1 and obv_2h <= -3 and obv_slope_2h >= 1 and adx_2h >= 100 and stochastic_k_2h >= 7 and stochastic_d_2h >= 7 and williams_r_2h <= -89) and 
                (rsi_4h >= 19 and macd_4h <= -1 and macd_signal_4h <= -1 and macd_hist_4h <= -1 and obv_4h <= -9 and obv_slope_4h >= 3 and adx_4h >= 32 and stochastic_k_4h >= 4 and stochastic_d_4h >= 6 and williams_r_4h <= -93)
            )

            # --- is_sell_momentum_19 ---
            is_sell_momentum_19 = (
                (rsi_1h >= 17 and macd_1h <= -1 and macd_signal_1h <= -1 and macd_hist_1h <= -3 and obv_1h >= 1 and obv_slope_1h <= -1 and adx_1h >= 57 and stochastic_k_1h >= 7 and stochastic_d_1h >= 11 and williams_r_1h <= -89) and 
                (rsi_2h >= 18 and macd_2h <= -2 and macd_signal_2h <= -1 and macd_hist_2h <= -5 and obv_2h <= -4 and obv_slope_2h <= -2 and adx_2h >= 70 and stochastic_k_2h >= 7 and stochastic_d_2h >= 7 and williams_r_2h <= -91) and 
                (rsi_4h >= 20 and macd_4h <= -3 and macd_signal_4h <= -2 and macd_hist_4h <= -7 and obv_4h >= 1 and obv_slope_4h <= -4 and adx_4h >= 87 and stochastic_k_4h >= 3 and stochastic_d_4h >= 5 and williams_r_4h <= -100)
            )

            # --- is_sell_momentum_20 ---
            is_sell_momentum_20 = (
                (rsi_1h >= 21 and macd_1h <= -4 and macd_signal_1h <= -3 and macd_hist_1h <= -1 and obv_1h <= -2 and obv_slope_1h <= -1 and adx_1h >= 77 and stochastic_k_1h >= 12 and stochastic_d_1h >= 12 and williams_r_1h <= -90) and 
                (rsi_2h >= 14 and macd_2h <= -5 and macd_signal_2h <= -4 and macd_hist_2h <= -1 and obv_2h <= -3 and obv_slope_2h <= -2 and adx_2h >= 62 and stochastic_k_2h >= 12 and stochastic_d_2h >= 10 and williams_r_2h <= -92) and 
                (rsi_4h >= 22 and macd_4h <= -8 and macd_signal_4h <= -7 and macd_hist_4h <= -1 and obv_4h <= -6 and obv_slope_4h <= -5 and adx_4h >= 17 and stochastic_k_4h >= 5 and stochastic_d_4h >= 7 and williams_r_4h <= -94)
            )

            # --- is_sell_momentum_21 ---
            is_sell_momentum_21 = (
                (rsi_1h >= 23 and macd_1h <= -5 and macd_signal_1h <= -4 and macd_hist_1h <= -1 and obv_1h >= 2 and obv_slope_1h <= -2 and adx_1h >= 70 and stochastic_k_1h >= 8 and stochastic_d_1h >= 7 and williams_r_1h <= -88) and 
                (rsi_2h >= 19 and macd_2h <= -6 and macd_signal_2h <= -5 and macd_hist_2h <= -1 and obv_2h >= 7 and obv_slope_2h <= -4 and adx_2h >= 28 and stochastic_k_2h >= 7 and stochastic_d_2h >= 9 and williams_r_2h <= -91) and 
                (rsi_4h >= 20 and macd_4h <= -9 and macd_signal_4h <= -5 and macd_hist_4h <= -3 and obv_4h >= 1 and obv_slope_4h <= -1 and adx_4h >= 62 and stochastic_k_4h >= 6 and stochastic_d_4h >= 12 and williams_r_4h <= -100)
            )

            # --- is_sell_momentum_22 ---
            is_sell_momentum_22 = (
                (rsi_1h >= 37 and macd_1h <= -2 and macd_signal_1h <= -2 and macd_hist_1h <= -2 and obv_1h <= -3 and obv_slope_1h >= 1 and adx_1h >= 23 and stochastic_k_1h >= 17 and stochastic_d_1h >= 7 and williams_r_1h <= -58) and 
                (rsi_2h >= 35 and macd_2h <= -2 and macd_signal_2h <= -1 and macd_hist_2h <= -7 and obv_2h >= 6 and obv_slope_2h >= 1 and adx_2h >= 65 and stochastic_k_2h >= 10 and stochastic_d_2h >= 7 and williams_r_2h <= -72) and 
                (rsi_4h >= 28 and macd_4h <= -3 and macd_signal_4h <= -1 and macd_hist_4h <= -1 and obv_4h >= 2 and obv_slope_4h <= -2 and adx_4h >= 3 and stochastic_k_4h >= 2 and stochastic_d_4h >= 3 and williams_r_4h <= -98)
            )

            # --- is_sell_momentum_23 ---
            is_sell_momentum_23 = (
                (rsi_1h >= 28 and macd_1h <= -1 and macd_signal_1h <= -1 and macd_hist_1h <= -3 and obv_1h <= -1 and obv_slope_1h <= -7 and adx_1h >= 3 and stochastic_k_1h >= 2 and stochastic_d_1h >= 4 and williams_r_1h <= -96) and 
                (rsi_2h >= 26 and macd_2h <= -3 and macd_signal_2h <= -4 and macd_hist_2h >= 2 and obv_2h <= -1 and obv_slope_2h <= -1 and adx_2h >= 1 and stochastic_k_2h >= 3 and stochastic_d_2h >= 8 and williams_r_2h <= -96) and 
                (rsi_4h >= 19 and macd_4h <= -1 and macd_signal_4h <= -1 and macd_hist_4h >= 1 and obv_4h <= -1 and obv_slope_4h <= -2 and adx_4h >= 23 and stochastic_k_4h >= 2 and stochastic_d_4h >= 3 and williams_r_4h <= -97)
            )

            # --- is_sell_momentum_24 ---
            is_sell_momentum_24 = (
                (rsi_1h >= 33 and macd_1h <= -1 and macd_signal_1h <= -1 and macd_hist_1h <= -2 and obv_1h <= -3 and obv_slope_1h >= 3 and adx_1h >= 33 and stochastic_k_1h >= 11 and stochastic_d_1h >= 15 and williams_r_1h <= -86) and 
                (rsi_2h >= 27 and macd_2h <= -1 and macd_signal_2h <= -1 and macd_hist_2h <= -4 and obv_2h <= -8 and obv_slope_2h <= -8 and adx_2h >= 50 and stochastic_k_2h >= 14 and stochastic_d_2h >= 17 and williams_r_2h <= -86) and 
                (rsi_4h >= 24 and macd_4h <= -2 and macd_signal_4h <= -1 and macd_hist_4h <= -9 and obv_4h <= -1 and obv_slope_4h <= -6 and adx_4h >= 38 and stochastic_k_4h >= 10 and stochastic_d_4h >= 14 and williams_r_4h <= -92)
            )

            # --- إدراج_شروط_زخم_بيع ---
            
            # --- تقييم_is_buy_momentum_1 ---
            if is_buy_momentum_1:
                score += 50
                reasons.append("زخم شراء إيجابي 0")
            ...
            # --- تقييم_is_buy_momentum_33 ---
            elif is_buy_momentum_33:
                score += 50
                reasons.append("زخم شراء إيجابي 33")

            # --- تقييم_is_buy_momentum_34 ---
            elif is_buy_momentum_34:
                score += 50
                reasons.append("زخم شراء إيجابي 34")

            # --- تقييم_is_buy_momentum_35 ---
            elif is_buy_momentum_35:
                score += 50
                reasons.append("زخم شراء إيجابي 35")

            # --- تقييم_is_buy_momentum_36 ---
            elif is_buy_momentum_36:
                score += 50
                reasons.append("زخم شراء إيجابي 36")

            # --- تقييم_is_buy_momentum_37 ---
            elif is_buy_momentum_37:
                score += 50
                reasons.append("زخم شراء إيجابي 37")

            # --- تقييم_is_buy_momentum_38 ---
            elif is_buy_momentum_38:
                score += 50
            ...
            # --- تقييم_is_sell_momentum_23 ---
            elif is_sell_momentum_23:
                score -= 50
                reasons.append("زخم بيع سلبي 23")

            # --- تقييم_is_sell_momentum_24 ---
...
async def unified_trading_system():
    ...
    while True:
        try:
            ...
            # 📡 المرحلة الثانية: تشغيل الرادار الأول (عين الصقر 1)
            print("🚀 إطلاق رادار عين الصقر 1 (v11.1) لمسح السوق الآن...")
            await intelligence_scanner()
            
            # ⏱️ فاصل زمني بين الرادارين: انتظار 5 ثوانٍ
            print("⏱️ اكتمال عين الصقر 1. جاري الانتظار 5 ثوانٍ قبل إطلاق عين الصقر 2...")
            await asyncio.sleep(5)
            
            # 🦅 المرحلة الثالثة: تشغيل الرادار الثاني (عين الصقر 2)
            print("🦅 إطلاق رادار عين الصقر 2 لمسح السوق الآن...")
            await intelligence_scanner2()
            ...
            await asyncio.sleep(10)  # 👈 يمكنك تعديل الـ 60 ثانية لأي وقت تراه مناسباً
            
            # 🦅 المرحلة الرابعة: تشغيل الرادار الثالث (عين الصقر 3)
            print("🦅 إطلاق رادار عين الصقر 3 لمسح السوق الآن...")
            await intelligence_scanner3()
